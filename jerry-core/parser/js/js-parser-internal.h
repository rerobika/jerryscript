...
#define PARSER_IS_MUTABLE_PUSH_LITERAL_BYTE(opcode) \
  ((opcode) >= CBC_PUSH_LITERAL_PUSH_NUMBER_0 && (opcode) <= CBC_PUSH_LITERAL_PUSH_NUMBER_POS_BYTE)

#define PARSER_IS_PUSH_PROP_BYTE(opcode) \
  ((opcode) >= CBC_PUSH_PROP_LITERAL_NUMBER_0 && (opcode) <= CBC_PUSH_PROP_LITERAL_NUMBER_POS_BYTE)

#define PARSER_PUSH_LITERAL_BYTE_TO_PUSH_PROP_LITERAL_BYTE(opcode) \
  (uint16_t) ((opcode) + (CBC_PUSH_PROP_LITERAL_NUMBER_0 - CBC_PUSH_LITERAL_PUSH_NUMBER_0))

#define PARSER_PUSH_PROP_LITERAL_BYTE_TO_PUSH_LITERAL_BYTE(opcode) \
  (uint16_t) ((opcode) - (CBC_PUSH_PROP_LITERAL_NUMBER_0 - CBC_PUSH_LITERAL_PUSH_NUMBER_0))
