...
#define CBC_OPCODE_LIST \
  ...
  CBC_BINARY_OPERATION (CBC_UNS_RIGHT_SHIFT, \
                        UNS_RIGHT_SHIFT) \
  CBC_OPCODE (CBC_STRING_CONCAT, CBC_HAS_POP_STACK_BYTE_ARG, 1, \
              VM_OC_STRING_CONCAT_MULTIPLE) \
  CBC_OPCODE (CBC_STRING_CONCAT_RIGHT_LITERAL, CBC_HAS_LITERAL_ARG, 0, \
              (VM_OC_STRING_CONCAT) | VM_OC_GET_STACK_LITERAL | VM_OC_PUT_STACK) \
  CBC_OPCODE (CBC_STRING_CONCAT_TWO_LITERALS, CBC_HAS_LITERAL_ARG | CBC_HAS_LITERAL_ARG2, 1, \
...
#define CBC_EXT_OPCODE_LIST \
  ...
  CBC_OPCODE (CBC_EXT_STRING_CONCAT, CBC_HAS_POP_STACK_BYTE_ARG, 1, \
              VM_OC_STRING_CONCAT_MULTIPLE) \
