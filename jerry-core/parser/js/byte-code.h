...
#define CBC_OPCODE_LIST                                                                                             \
  ...
  CBC_OPCODE (CBC_RETURN_WITH_BLOCK, CBC_NO_FLAG, 0, VM_OC_RETURN)                                                  \
  ...
  CBC_OPCODE (CBC_ASSIGN_SUPER, CBC_NO_FLAG, -3, VM_OC_ASSIGN_SUPER)                                                \
  CBC_OPCODE (CBC_ASSIGN_SUPER_PUSH_RESULT, CBC_NO_FLAG, -2, VM_OC_ASSIGN_SUPER | VM_OC_PUT_STACK)                  \
  CBC_OPCODE (CBC_ASSIGN_SUPER_BLOCK, CBC_NO_FLAG, -3, VM_OC_ASSIGN_SUPER | VM_OC_PUT_BLOCK)                        \
                                                                                                                    \
...
#define CBC_EXT_OPCODE_LIST                                                                                            \
  ...
  CBC_OPCODE (CBC_EXT_PUSH_LITERAL_PUSH_NUMBER_0, CBC_HAS_LITERAL_ARG, 2, VM_OC_PUSH_LIT_0 | VM_OC_GET_LITERAL)        \
  CBC_OPCODE (CBC_EXT_PUSH_LITERAL_PUSH_NUMBER_POS_BYTE,                                                               \
              CBC_HAS_LITERAL_ARG | CBC_HAS_BYTE_ARG,                                                                  \
              2,                                                                                                       \
              VM_OC_PUSH_LIT_POS_BYTE | VM_OC_GET_LITERAL)                                                             \
  CBC_OPCODE (CBC_EXT_PUSH_LITERAL_PUSH_NUMBER_NEG_BYTE,                                                               \
              CBC_HAS_LITERAL_ARG | CBC_HAS_BYTE_ARG,                                                                  \
              2,                                                                                                       \
  ...
  CBC_OPCODE (CBC_EXT_LINE, CBC_NO_FLAG, 0, VM_OC_LINE)                                                                \
