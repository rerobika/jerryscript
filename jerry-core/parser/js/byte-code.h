...
#define CBC_EXT_NO_RESULT_OPERATION(opcode) \
  ((opcode) >= PARSER_TO_EXT_OPCODE (CBC_EXT_SUPER_CALL) \
    && (opcode) <= PARSER_TO_EXT_OPCODE (CBC_EXT_SPREAD_CALL_PROP_PUSH_RESULT))
#else /* !JERRY_ESNEXT */
/**
 * CBC_NO_RESULT_OPERATION for ext opcodes
 */
...
#define CBC_OPCODE_LIST \
  ...
  /* Note: These 3 opcodes must me in this order */ \
  CBC_OPCODE (CBC_RETURN, CBC_NO_FLAG, -1, \
              VM_OC_RETURN | VM_OC_GET_STACK) \
  CBC_OPCODE (CBC_RETURN_UNDEFINED, CBC_NO_FLAG, 0, \
              VM_OC_RETURN) \
  CBC_OPCODE (CBC_RETURN_LITERAL, CBC_HAS_LITERAL_ARG, 0, \
              VM_OC_RETURN | VM_OC_GET_LITERAL) \
  CBC_OPCODE (CBC_RETURN_BLOCK, CBC_NO_FLAG, 0, \
              VM_OC_RETURN_BLOCK) \
...
#define CBC_EXT_OPCODE_LIST \
  ...
  /* Note: These 3 opcodes must me in this order */ \
  CBC_OPCODE (CBC_EXT_CONTEXT_RETURN, CBC_NO_FLAG, -1, \
              VM_OC_CONTEXT_RETURN | VM_OC_GET_STACK) \
  CBC_OPCODE (CBC_EXT_CONTEXT_RETURN_UNDEFINED, CBC_NO_FLAG, 0, \
              VM_OC_CONTEXT_RETURN) \
  CBC_OPCODE (CBC_EXT_CONTEXT_RETURN_LITERAL, CBC_HAS_LITERAL_ARG, 0, \
              VM_OC_CONTEXT_RETURN | VM_OC_GET_LITERAL) \
