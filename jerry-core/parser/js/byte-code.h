...
#define CBC_OPCODE_LIST \
  ...
  CBC_OPCODE (CBC_FOR_END_INCREASE_IDENT, CBC_HAS_LITERAL_ARG, 0, \
              VM_OC_FOR_END_INCREASE_IDENT) \
  CBC_OPCODE (CBC_FOR_END_LESS_IDENT, CBC_HAS_LITERAL_ARG, 1, \
              VM_OC_FOR_END_LESS_IDENT) \
  \
  /* Unary opcodes. */ \
