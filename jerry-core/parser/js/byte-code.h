...
#define CBC_OPCODE_LIST \
  ...
  /* Note: These 2 opcodes must me in this order */ \
  CBC_OPCODE (CBC_PUSH_PROP_LITERAL_NUMBER_0, CBC_HAS_LITERAL_ARG, 1, \
              VM_OC_PUSH_PROP_LIT_0 | VM_OC_GET_LITERAL) \
  CBC_OPCODE (CBC_PUSH_PROP_LITERAL_NUMBER_POS_BYTE, CBC_HAS_LITERAL_ARG | CBC_HAS_BYTE_ARG, 1, \
              VM_OC_PUSH_PROP_LIT_POS_BYTE | VM_OC_GET_LITERAL) \
