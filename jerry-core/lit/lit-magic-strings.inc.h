...
#endif
#if JERRY_BUILTIN_CONTAINER || JERRY_BUILTIN_MAP || JERRY_ESNEXT
LIT_MAGIC_STRING_DEF (LIT_MAGIC_STRING_MAP_UL, "Map")
#endif
LIT_MAGIC_STRING_DEF (LIT_MAGIC_STRING_NAN, "NaN")
#if JERRY_BUILTIN_CONTAINER || JERRY_BUILTIN_SET || JERRY_ESNEXT
...
#endif
#if JERRY_BUILTIN_CONTAINER && JERRY_ESNEXT || JERRY_BUILTIN_SET || JERRY_BUILTIN_WEAKSET
...
#if JERRY_BUILTIN_MAP || JERRY_BUILTIN_PROXY || JERRY_BUILTIN_REFLECT || JERRY_BUILTIN_SET || JERRY_BUILTIN_WEAKMAP \
...
#if JERRY_BUILTIN_MAP || JERRY_BUILTIN_SET || JERRY_ESNEXT
...
#endif
#if !JERRY_ESNEXT && JERRY_BUILTIN_REGEXP || JERRY_BUILTIN_REGEXP && JERRY_ESNEXT \
...
#endif
#if JERRY_BUILTIN_MAP || JERRY_BUILTIN_SET || JERRY_BUILTIN_TYPEDARRAY || JERRY_ESNEXT
...
#endif
#if JERRY_BUILTIN_CONTAINER || JERRY_BUILTIN_WEAKMAP
...
#endif
#if JERRY_BUILTIN_ARRAY || JERRY_BUILTIN_MAP || JERRY_BUILTIN_SET || JERRY_BUILTIN_TYPEDARRAY
...
#endif
#if JERRY_BUILTIN_DATE && !(JERRY_ESNEXT) || JERRY_ESNEXT
...
#endif
#if JERRY_BUILTIN_MAP || JERRY_ESNEXT
LIT_MAGIC_STRING_DEF (LIT_MAGIC_STRING_MAP_ITERATOR_UL, "Map Iterator")
#endif
#if JERRY_BUILTIN_SET || JERRY_ESNEXT
...
#elif JERRY_BUILTIN_CONTAINER || JERRY_BUILTIN_MAP || JERRY_ESNEXT
