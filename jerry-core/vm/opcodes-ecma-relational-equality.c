                   ...
                   ecma_value_t right_value) /**< right value */
{
  ...
  if (JERRY_UNLIKELY (!ecma_is_value_undefined (has_instance_method)))
  {
    ...
    ecma_func_args_t func_args = ecma_op_make_call_args (method_obj_p, right_value, &left_value, 1);
    ecma_value_t has_instance_result = ecma_op_function_call (&func_args);
