                   ...
                   ecma_value_t right_value) /**< right value */
{
  ...
  if (JERRY_UNLIKELY (!ecma_is_value_undefined (has_instance_method)))
  {
    ...
    ecma_value_t has_instance_result = call_call_internal_method (method_obj_p, right_value, &left_value, 1);
           ...
           ecma_value_t right_value) /**< right value */
{
  ...
  ecma_object_t *right_value_obj_p = ecma_get_object_from_value (right_value);
  ecma_value_t result = call_has_property_internal_method (right_value_obj_p, property_name_p);
