...
ecma_value_t opfunc_init_class_fields (ecma_value_t class_object, ecma_value_t this_val);
...
ecma_value_t opfunc_create_implicit_class_constructor (uint8_t opcode);
