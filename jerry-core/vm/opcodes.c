                   ...
                   bool is_strict) /**< strict mode */
{
  ...
  ecma_value_t delete_op_ret = call_delete_internal_method (obj_p, name_string_p, is_strict);
...
opfunc_define_field (ecma_value_t base, ecma_value_t property, ecma_value_t value)
{
  ...
  ecma_value_t result = call_define_own_property_internal_method (obj_p, property_key_p, &desc);
                    ...
                    ecma_value_t value) /**< ecma value */
{
  ...
  return call_call_internal_method (setter_p, base, &value, 1);
} /* opfunc_private_set */
                    ...
                    ecma_value_t property) /**< property name */
{
  ...
  else
  {
    ...
    else
    {
      ...
      result = call_call_internal_method (getter_p, base, NULL, 0);
    }
  }
                             ...
                             uint8_t opcode) /**< current cbc opcode */
{
  ...
  ecma_value_t result = call_get_internal_method (parent_p, prop_name_p, frame_ctx_p->this_binding);
                               ...
                               uint32_t opcode_data) /**< opcode data to store the result */
{
  ...
  ecma_value_t result =
    call_set_internal_method (base_obj_p, prop_name_p, stack_top_p[-1], frame_ctx_p->this_binding, is_strict);
                             ...
                             ecma_value_t filter_array) /**< filter array */
{
  ...
  ecma_collection_t *names_p = call_own_property_keys_internal_method (source_object_p, JERRY_PROPERTY_FILTER_ALL);
  ...
  while (buffer_p < buffer_end_p)
  {
    ...
    ecma_property_descriptor_t prop_desc = call_get_own_property_internal_method (source_object_p, property_name_p);
    ...
    {
      result = call_get_internal_method (source_object_p, property_name_p, source_object);
                                             ...
                                             ecma_string_t *name_p) /**< binding name */
{
  ...
  ecma_property_descriptor_t prop_desc = call_get_own_property_internal_method (global_obj_p, name_p);
