                 ...
                 ecma_value_t property) /**< property name */
{
  if (ecma_is_value_object (object))
  {
    ...
    if (property_name_p != NULL)
    {
      ...
      return call_get_internal_method (object_p, property_name_p, object);
    }
  }
                 ...
                 bool is_strict) /**< strict mode */
{
  ...
  if (JERRY_UNLIKELY (!ecma_is_value_object (base)))
  {
    ...
    result = call_set_internal_method (object_p, property_p, value, base, is_strict);
...
vm_super_call (vm_frame_ctx_t *frame_ctx_p) /**< frame context */
{
  ...
  else
  {
    ...
    completion_value = call_construct_internal_method (func_obj_p,
...
vm_spread_operation (vm_frame_ctx_t *frame_ctx_p) /**< frame context */
{
  ...
  if (frame_ctx_p->byte_code_p[1] == CBC_EXT_SPREAD_NEW)
  {
    ...
    else
    {
      ...
      completion_value = call_construct_internal_method (constructor_obj_p,
                                                         constructor_obj_p,
  ...
  else
  {
    ...
    completion_value =
      call_validated_call_internal_method (func_value, this_value, collection_p->buffer_p, collection_p->item_count);
...
opfunc_call (vm_frame_ctx_t *frame_ctx_p) /**< frame context */
{
  ...
  ecma_value_t completion_value =
    call_validated_call_internal_method (func_value, this_value, stack_top_p, arguments_list_len);
...
opfunc_construct (vm_frame_ctx_t *frame_ctx_p) /**< frame context */
{
  ...
  else
  {
    ...
    completion_value =
      call_construct_internal_method (constructor_obj_p, constructor_obj_p, stack_top_p, arguments_list_len);
  }
  ...
  while (true)
  {
    ...
    while (true)
    {
      ...
      switch (VM_OC_GROUP_GET_INDEX (opcode_data))
      {
        ...
        {
          result =
            call_call_internal_method (ecma_get_object_from_value (left_value), frame_ctx_p->this_binding, NULL, 0);
        ...
        case VM_OC_FOR_IN_HAS_NEXT:
        {
          ...
          while (index < collection_p->item_count)
          {
            ...
            result = call_has_property_internal_method (object_p, prop_name_p);
