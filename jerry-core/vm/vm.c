...
#define VM_OPCODE_OP_ARITHMETIC(op)                 \
  VM_OPCODE_OP_STACK_LITERAL (op##_RIGHT_LITERAL);  \
...
#define VM_RESOLVE_LITERAL_OPCODE (VM_EXT_OPCODE_LAST + 1)
#define VM_DECODE_BRANCH_OFFSET   (VM_RESOLVE_LITERAL_OPCODE + 1)
#define VM_DECODE_BACKWARD_BRANCH (VM_DECODE_BRANCH_OFFSET + 1)

#define VM_OPCODE_UNREACHABLE_BLOCK if (0)

#define VM_OPCODE_OP_NONE(op) \
  left_value = result;        \
...
#define VM_OPCODE_OP_LITERAL(op)       \
  left_value = result;                 \
  VM_OPCODE_UNREACHABLE_BLOCK          \
  {                                    \
    case op:                           \
    {                                  \
      goto dispatch_literal_resolving; \
    }                                  \
  }

#define VM_OPCODE_2_OP_LITERAL(op1, op2) \
  left_value = result;                   \
  VM_OPCODE_UNREACHABLE_BLOCK            \
  {                                      \
    case op1:                            \
...
#define VM_OPCODE_OP_LITERAL_LITERAL(op) \
  right_value = result;                  \
  VM_OPCODE_UNREACHABLE_BLOCK            \
  {                                      \
    case op:                             \
...
#define VM_OPCODE_2_OP_LITERAL_LITERAL(op1, op2) \
  right_value = result;                          \
  VM_OPCODE_UNREACHABLE_BLOCK                    \
  {                                              \
    case op1:                                    \
...
#define VM_OPCODE_OP_THIS_LITERAL(op)                           \
  right_value = result;                                         \
  VM_OPCODE_UNREACHABLE_BLOCK                                   \
  {                                                             \
    case op:                                                    \
...
#define VM_OPCODE_2_OP_THIS_LITERAL(op1, op2)                   \
  right_value = result;                                         \
  VM_OPCODE_UNREACHABLE_BLOCK                                   \
  {                                                             \
    case op1:                                                   \
...
#define VM_OPCODE_2_OP_STACK(op1, op2) \
  VM_OPCODE_UNREACHABLE_BLOCK          \
  {                                    \
    case op1:                          \
    case op2:                          \
...
#define VM_OPCODE_OP_STACK_STACK(op)                \
  VM_OPCODE_UNREACHABLE_BLOCK                       \
  {                                                 \
    case op:                                        \
    {                                               \
...
#define VM_OPCODE_2_OP_STACK_STACK(op1, op2)        \
  VM_OPCODE_UNREACHABLE_BLOCK                       \
  {                                                 \
    case op1:                                       \
    case op2:                                       \
...
#define VM_OPCODE_OP_STACK_LITERAL(op) \
  right_value = result;                \
  VM_OPCODE_UNREACHABLE_BLOCK          \
  {                                    \
    case op:                           \
...
#define VM_OPCODE_2_OP_STACK_LITERAL(op1, op2) \
  right_value = result;                        \
  VM_OPCODE_UNREACHABLE_BLOCK                  \
  {                                            \
    case op1:                                  \
...
/* branch */
#define VM_OPCODE_OP_FORWARD_BRANCH(op)   \
  VM_OPCODE_UNREACHABLE_BLOCK             \
  {                                       \
    case op:                              \
    case op##_2:                          \
    case op##_3:                          \
    {                                     \
      goto dispatch_decode_branch_offset; \
    }                                     \
  }

#define VM_OPCODE_OP_BACKWARD_BRANCH(op)    \
  VM_OPCODE_UNREACHABLE_BLOCK               \
  {                                         \
    case op:                                \
    case op##_2:                            \
    case op##_3:                            \
    {                                       \
      goto dispatch_decode_backward_branch; \
    }                                       \
  }                                         \
...
#define VM_EXT_OPCODE_OP_ARITHMETIC(op)                 \
  VM_EXT_OPCODE_OP_STACK_LITERAL (op##_RIGHT_LITERAL);  \
  VM_EXT_OPCODE_OP_LITERAL_LITERAL (op##_TWO_LITERALS); \
  VM_EXT_OPCODE_OP_STACK_STACK (op)

#define VM_EXT_OPCODE_OP_NONE(op)            VM_OPCODE_OP_NONE (VM_EXT_OPCODE (op))
#define VM_EXT_OPCODE_OP_STACK(op)           VM_OPCODE_OP_STACK (VM_EXT_OPCODE (op))
#define VM_EXT_OPCODE_OP_STACK_STACK(op)     VM_OPCODE_OP_STACK_STACK (VM_EXT_OPCODE (op))
#define VM_EXT_OPCODE_OP_STACK_LITERAL(op)   VM_OPCODE_OP_STACK_LITERAL (VM_EXT_OPCODE (op))
#define VM_EXT_OPCODE_OP_LITERAL(op)         VM_OPCODE_OP_LITERAL (VM_EXT_OPCODE (op))
#define VM_EXT_OPCODE_OP_LITERAL_LITERAL(op) VM_OPCODE_OP_LITERAL_LITERAL (VM_EXT_OPCODE (op))

#define VM_EXT_OPCODE_2_OP_STACK(op1, op2)       VM_OPCODE_2_OP_STACK (VM_EXT_OPCODE (op1), VM_EXT_OPCODE (op2))
#define VM_EXT_OPCODE_2_OP_STACK_STACK(op1, op2) VM_OPCODE_2_OP_STACK_STACK (VM_EXT_OPCODE (op1), VM_EXT_OPCODE (op2))
#define VM_EXT_OPCODE_2_OP_STACK_LITERAL(op1, op2) \
  VM_OPCODE_2_OP_STACK_LITERAL (VM_EXT_OPCODE (op1), VM_EXT_OPCODE (op2))
#define VM_EXT_OPCODE_2_OP_LITERAL(op1, op2) VM_OPCODE_2_OP_LITERAL (VM_EXT_OPCODE (op1), VM_EXT_OPCODE (op2))
#define VM_EXT_OPCODE_2_OP_LITERAL_LITERAL(op1, op2) \
  VM_OPCODE_2_OP_LITERAL_LITERAL (VM_EXT_OPCODE (op1), VM_EXT_OPCODE (op2))

#define VM_EXT_OPCODE_OP_FORWARD_BRANCH(op) \
  VM_OPCODE_UNREACHABLE_BLOCK               \
  {                                         \
...
#define VM_EXT_OPCODE_OP_BACKWARD_BRANCH(op) \
  VM_OPCODE_UNREACHABLE_BLOCK                \
  {                                          \
    case VM_EXT_OPCODE (op):                 \
    case VM_EXT_OPCODE (op##_2):             \
...
dispatch_opcode:
      switch (opcode)
      {
        case VM_DECODE_BACKWARD_BRANCH:
        {
dispatch_decode_backward_branch:
#if JERRY_VM_HALT
        ...
        case VM_DECODE_BRANCH_OFFSET:
        {
          uint8_t branch_offset_length;
dispatch_decode_branch_offset:
          ...
          while (JERRY_UNLIKELY (branch_offset_length > 1))
          {
            branch_offset <<= 8;
            branch_offset |= *(byte_code_p++);
        ...
        case VM_RESOLVE_LITERAL_OPCODE:
        {
          uint16_t literal_index;
dispatch_literal_resolving:
          READ_LITERAL_INDEX (literal_index);

          if (literal_index < register_end)
          {
            /* Note: There should be no specialization for arguments. */
            result = ecma_fast_copy_value (VM_GET_REGISTER (frame_ctx_p, literal_index));
          }
          ...
          {
            result = ecma_fast_copy_value (literal_start_p[literal_index]);
          }
          else
          {
            /* Object construction. */
            result = vm_construct_literal_object (frame_ctx_p, literal_start_p[literal_index]);
          }
        ...
        {
          VM_OPCODE_OP_LITERAL (CBC_PUSH_LITERAL);
        ...
        {
          VM_OPCODE_OP_LITERAL_LITERAL (CBC_PUSH_TWO_LITERALS);
        ...
        {
          VM_OPCODE_OP_THIS_LITERAL (CBC_PUSH_THIS_LITERAL)
        ...
        {
          VM_OPCODE_OP_LITERAL_LITERAL (CBC_PUSH_THREE_LITERALS);
        ...
        {
          VM_OPCODE_OP_LITERAL (CBC_PUSH_LITERAL_PUSH_NUMBER_0);
        ...
        {
          VM_OPCODE_OP_LITERAL (CBC_PUSH_LITERAL_PUSH_NUMBER_POS_BYTE);
          ecma_integer_value_t number = *byte_code_p++;
          stack_top_p[0] = left_value;
        ...
        {
          VM_OPCODE_OP_LITERAL (CBC_PUSH_LITERAL_PUSH_NUMBER_NEG_BYTE);
          ecma_integer_value_t number = *byte_code_p++;
          stack_top_p[0] = left_value;
          stack_top_p[1] = ecma_make_integer_value (-(number + 1));
          stack_top_p += 2;
        ...
        {
          VM_EXT_OPCODE_OP_LITERAL_LITERAL (CBC_EXT_PUSH_NAMED_FUNC_EXPRESSION);
        ...
        {
          VM_OPCODE_OP_LITERAL (CBC_ASSIGN_LET_CONST_LITERAL);
          VM_OPCODE_OP_STACK (CBC_ASSIGN_LET_CONST);
        ...
        {
          VM_OPCODE_OP_LITERAL (CBC_COPY_TO_GLOBAL);
        ...
        {
          VM_EXT_OPCODE_OP_LITERAL (CBC_EXT_CLASS_CALL_STATIC_BLOCK);
        ...
        {
          VM_EXT_OPCODE_2_OP_LITERAL (CBC_EXT_PUSH_STATIC_FIELD_FUNC, CBC_EXT_PUSH_STATIC_COMPUTED_FIELD_FUNC);
          ...
          VM_EXT_OPCODE_2_OP_STACK (CBC_EXT_ADD_COMPUTED_FIELD, CBC_EXT_ADD_STATIC_COMPUTED_FIELD);
        ...
        {
          VM_EXT_OPCODE_OP_STACK_LITERAL (CBC_EXT_SET_COMPUTED_PROPERTY_LITERAL);
          VM_EXT_OPCODE_2_OP_STACK_STACK (CBC_EXT_SET_COMPUTED_PROPERTY, CBC_EXT_SET_STATIC_COMPUTED_PROPERTY);

          result = opfunc_set_property (stack_top_p,
                                        left_value,
                                        right_value,
        ...
        {
          VM_OPCODE_2_OP_STACK_LITERAL (CBC_SET_PROPERTY, VM_EXT_OPCODE (CBC_EXT_SET_STATIC_PROPERTY));

          VM_OPCODE_2_OP_LITERAL_LITERAL (CBC_SET_LITERAL_PROPERTY,
                                          VM_EXT_OPCODE (CBC_EXT_SET_STATIC_PROPERTY_LITERAL));

          result = opfunc_set_property (stack_top_p, right_value, left_value, *byte_code_start_p == CBC_EXT_OPCODE);
        ...
        case VM_EXT_OPCODE_TWO_LITERALS (CBC_EXT_SET_STATIC_SETTER):
        {
          ...
          VM_EXT_OPCODE_2_OP_LITERAL_LITERAL (CBC_EXT_SET_GETTER, CBC_EXT_SET_STATIC_GETTER);
          VM_EXT_OPCODE_2_OP_LITERAL_LITERAL (CBC_EXT_SET_SETTER, CBC_EXT_SET_STATIC_SETTER);

          VM_EXT_OPCODE_2_OP_STACK_STACK (CBC_EXT_SET_COMPUTED_GETTER, CBC_EXT_SET_STATIC_COMPUTED_GETTER);
          VM_EXT_OPCODE_2_OP_STACK_STACK (CBC_EXT_SET_COMPUTED_SETTER, CBC_EXT_SET_STATIC_COMPUTED_SETTER);
        ...
        {
          VM_EXT_OPCODE_OP_STACK_LITERAL (CBC_EXT_DEFINE_FIELD);
        ...
        {
          VM_EXT_OPCODE_OP_STACK_LITERAL (CBC_EXT_PRIVATE_FIELD_ADD);
        ...
        {
          VM_EXT_OPCODE_OP_STACK_LITERAL (CBC_EXT_PUSH_PRIVATE_PROP_LITERAL);
        ...
        {
          VM_EXT_OPCODE_OP_LITERAL (CBC_EXT_PUSH_PRIVATE_PROP_LITERAL_REFERENCE);
        ...
        {
          VM_EXT_OPCODE_OP_STACK_LITERAL (CBC_EXT_PUSH_PRIVATE_PROP_LITERAL_IN);
        ...
        {
          JERRY_ASSERT (*byte_code_start_p == CBC_EXT_OPCODE);
          VM_EXT_OPCODE_2_OP_LITERAL (CBC_EXT_COLLECT_PRIVATE_FIELD, CBC_EXT_COLLECT_PRIVATE_STATIC_FIELD);
        ...
        {
          JERRY_ASSERT (*byte_code_start_p == CBC_EXT_OPCODE);
          VM_EXT_OPCODE_2_OP_LITERAL_LITERAL (CBC_EXT_COLLECT_PRIVATE_METHOD, CBC_EXT_COLLECT_PRIVATE_STATIC_METHOD);
        ...
        {
          JERRY_ASSERT (*byte_code_start_p == CBC_EXT_OPCODE);
          VM_EXT_OPCODE_2_OP_LITERAL_LITERAL (CBC_EXT_COLLECT_PRIVATE_GETTER, CBC_EXT_COLLECT_PRIVATE_STATIC_GETTER);
          VM_EXT_OPCODE_2_OP_LITERAL_LITERAL (CBC_EXT_COLLECT_PRIVATE_SETTER, CBC_EXT_COLLECT_PRIVATE_STATIC_SETTER);
        ...
        {
          VM_EXT_OPCODE_OP_LITERAL (CBC_EXT_SET_FIELD_INIT);
        ...
        {
          VM_EXT_OPCODE_OP_STACK (CBC_EXT_SUPER_PROP_ASSIGNMENT_REFERENCE)
          VM_EXT_OPCODE_OP_LITERAL (CBC_EXT_SUPER_PROP_LITERAL_ASSIGNMENT_REFERENCE);
        ...
        case VM_EXT_OPCODE_ONE_LITERAL (CBC_EXT_PUSH_SUPER_PROP_LITERAL):
        {
          ...
          VM_EXT_OPCODE_2_OP_STACK (CBC_EXT_PUSH_SUPER_PROP, CBC_EXT_SUPER_PROP_REFERENCE)
          VM_EXT_OPCODE_2_OP_LITERAL (CBC_EXT_PUSH_SUPER_PROP_LITERAL, CBC_EXT_SUPER_PROP_LITERAL_REFERENCE);
        ...
        {
          VM_EXT_OPCODE_OP_LITERAL (CBC_EXT_SET_FUNCTION_NAME);
        ...
        {
          VM_EXT_OPCODE_OP_FORWARD_BRANCH (CBC_EXT_DEFAULT_INITIALIZER);
        ...
        {
          VM_EXT_OPCODE_OP_STACK (CBC_EXT_INITIALIZER_PUSH_NAME);
          VM_EXT_OPCODE_OP_LITERAL (CBC_EXT_INITIALIZER_PUSH_NAME_LITERAL);
        ...
        {
          VM_EXT_OPCODE_OP_LITERAL (CBC_EXT_INITIALIZER_PUSH_PROP_LITERAL);
          VM_EXT_OPCODE_OP_NONE (CBC_EXT_INITIALIZER_PUSH_PROP);
        ...
        {
          VM_EXT_OPCODE_OP_STACK (CBC_EXT_RETURN);
          result = left_value;
          left_value = ECMA_VALUE_UNDEFINED;
        ...
        {
          VM_EXT_OPCODE_OP_ARITHMETIC (CBC_EXT_STRING_CONCAT);
        ...
        {
          VM_OPCODE_OP_STACK_LITERAL (CBC_PUSH_PROP_LITERAL);
          VM_OPCODE_OP_LITERAL_LITERAL (CBC_PUSH_PROP_LITERAL_LITERAL);
          VM_OPCODE_OP_THIS_LITERAL (CBC_PUSH_PROP_THIS_LITERAL);
          VM_OPCODE_OP_STACK_STACK (CBC_PUSH_PROP);
        ...
        {
          VM_OPCODE_OP_LITERAL_LITERAL (CBC_PUSH_PROP_LITERAL_LITERAL_REFERENCE);
          VM_OPCODE_OP_THIS_LITERAL (CBC_PUSH_PROP_THIS_LITERAL_REFERENCE);
        ...
        case CBC_PUSH_PROP_REFERENCE:
        {
          VM_OPCODE_UNREACHABLE_BLOCK
          {
            case CBC_PUSH_PROP_LITERAL_REFERENCE:
            {
              goto dispatch_literal_resolving;
            }
        ...
        case VM_OPCODE_ONE_LITERAL_PUT_RESULT_CASE (CBC_POST_DECR_IDENT):
        {
          ...
          VM_OPCODE_UNREACHABLE_BLOCK
          {
            case VM_OPCODE_PUT_RESULT_CASE (CBC_PRE_INCR_IDENT):
            case VM_OPCODE_PUT_RESULT_CASE (CBC_PRE_DECR_IDENT):
            case VM_OPCODE_PUT_RESULT_CASE (CBC_POST_INCR_IDENT):
            case VM_OPCODE_PUT_RESULT_CASE (CBC_POST_DECR_IDENT):
            {
              goto dispatch_literal_resolving;
            }
          }
          ...
          else
          {
            ...
            if (JERRY_UNLIKELY (ecma_is_value_bigint (left_value)))
            {
...
post_incr_decr:
        ...
        case VM_OPCODE_ONE_LITERAL_PUT_RESULT_CASE (CBC_ASSIGN_LITERAL_SET_IDENT):
        {
          VM_OPCODE_UNREACHABLE_BLOCK
          {
            case VM_OPCODE_PUT_RESULT_CASE (CBC_ASSIGN_LITERAL_SET_IDENT):
            {
              goto dispatch_literal_resolving;
            }
          }
        ...
        case VM_OPCODE_ONE_LITERAL_PUT_RESULT_CASE (CBC_ASSIGN_PROP_LITERAL):
        {
          VM_OPCODE_UNREACHABLE_BLOCK
          {
            case VM_OPCODE_PUT_RESULT_CASE (CBC_ASSIGN_PROP_LITERAL):
            {
              goto dispatch_literal_resolving;
            }
          }

          VM_SWAP_VALUES (stack_top_p[-1], result);
          put_result_flags =
        ...
        case VM_OPCODE_ONE_LITERAL_PUT_RESULT_CASE (CBC_ASSIGN_PROP_THIS_LITERAL):
        {
          VM_OPCODE_UNREACHABLE_BLOCK
          {
            case VM_OPCODE_PUT_RESULT_CASE (CBC_ASSIGN_PROP_THIS_LITERAL):
            {
              goto dispatch_literal_resolving;
            }
          }

          stack_top_p[0] = result;
        ...
        {
          VM_OPCODE_OP_FORWARD_BRANCH (CBC_JUMP_FORWARD);
          byte_code_p = byte_code_start_p + branch_offset;
          continue;
        }
        case VM_OPCODE_BRANCH_CASE (CBC_JUMP_BACKWARD):
        {
          VM_OPCODE_OP_BACKWARD_BRANCH (CBC_JUMP_BACKWARD);
          byte_code_p = byte_code_start_p + branch_offset;
          continue;
        }
        case VM_OPCODE_BRANCH_CASE (CBC_BRANCH_IF_STRICT_EQUAL):
        {
          VM_OPCODE_OP_FORWARD_BRANCH (CBC_BRANCH_IF_STRICT_EQUAL);
        ...
        {
          VM_OPCODE_OP_FORWARD_BRANCH (CBC_BRANCH_IF_TRUE_FORWARD);

          VM_OPCODE_UNREACHABLE_BLOCK
          {
            case VM_OPCODE_BRANCH_CASE (CBC_BRANCH_IF_TRUE_BACKWARD):
            {
              VM_OPCODE_OP_BACKWARD_BRANCH (CBC_BRANCH_IF_TRUE_BACKWARD);
            }
          }
        ...
        {
          VM_OPCODE_OP_FORWARD_BRANCH (CBC_BRANCH_IF_FALSE_FORWARD);

          VM_OPCODE_UNREACHABLE_BLOCK
          {
            case VM_OPCODE_BRANCH_CASE (CBC_BRANCH_IF_FALSE_BACKWARD):
            {
              VM_OPCODE_OP_BACKWARD_BRANCH (CBC_BRANCH_IF_FALSE_BACKWARD);
            }
          }
        ...
        {
          VM_OPCODE_OP_FORWARD_BRANCH (CBC_BRANCH_IF_LOGICAL_TRUE);
        ...
        {
          VM_OPCODE_OP_FORWARD_BRANCH (CBC_BRANCH_IF_LOGICAL_FALSE);
        ...
        {
          VM_EXT_OPCODE_OP_FORWARD_BRANCH (CBC_EXT_BRANCH_IF_NULLISH);
        ...
        {
          VM_OPCODE_2_OP_LITERAL (CBC_PLUS_LITERAL, CBC_NEGATE_LITERAL)
          VM_OPCODE_2_OP_STACK (CBC_PLUS, CBC_NEGATE);
        ...
        {
          VM_OPCODE_OP_LITERAL (CBC_LOGICAL_NOT_LITERAL);
          VM_OPCODE_OP_STACK (CBC_LOGICAL_NOT);
        ...
        {
          VM_OPCODE_OP_LITERAL (CBC_BIT_NOT_LITERAL);
          VM_OPCODE_OP_STACK (CBC_BIT_NOT);
        ...
        {
          VM_OPCODE_OP_LITERAL (CBC_VOID_LITERAL);
          VM_OPCODE_OP_STACK (CBC_VOID);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_ADD);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_SUBTRACT);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_MULTIPLY);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_DIVIDE);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_MODULO);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_EXPONENTIATION);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_EQUAL);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_NOT_EQUAL);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_STRICT_EQUAL);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_STRICT_NOT_EQUAL);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_BIT_OR);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_BIT_XOR);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_BIT_AND);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_LEFT_SHIFT);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_RIGHT_SHIFT);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_UNS_RIGHT_SHIFT);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_LESS);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_GREATER);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_LESS_EQUAL);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_GREATER_EQUAL);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_IN);
        ...
        {
          VM_OPCODE_OP_ARITHMETIC (CBC_INSTANCEOF);
        ...
        {
          VM_OPCODE_OP_FORWARD_BRANCH (CBC_BLOCK_CREATE_CONTEXT);
        ...
        {
          VM_EXT_OPCODE_OP_FORWARD_BRANCH (CBC_EXT_WITH_CREATE_CONTEXT);
        ...
        {
          VM_EXT_OPCODE_OP_FORWARD_BRANCH (CBC_EXT_FOR_IN_INIT);
        ...
        {
          VM_EXT_OPCODE_OP_BACKWARD_BRANCH (CBC_EXT_BRANCH_IF_FOR_IN_HAS_NEXT);
        ...
        {
          VM_EXT_OPCODE_OP_FORWARD_BRANCH (CBC_EXT_FOR_OF_INIT);
        ...
        {
          VM_EXT_OPCODE_OP_BACKWARD_BRANCH (CBC_EXT_BRANCH_IF_FOR_OF_HAS_NEXT);
        ...
        {
          VM_EXT_OPCODE_OP_FORWARD_BRANCH (CBC_EXT_FOR_AWAIT_OF_INIT);
        ...
        {
          VM_EXT_OPCODE_OP_BACKWARD_BRANCH (CBC_EXT_BRANCH_IF_FOR_AWAIT_OF_HAS_NEXT);
        ...
        {
          VM_EXT_OPCODE_OP_FORWARD_BRANCH (CBC_EXT_TRY_CREATE_CONTEXT);
        ...
        {
          VM_EXT_OPCODE_OP_FORWARD_BRANCH (CBC_EXT_CATCH);
        ...
        {
          VM_EXT_OPCODE_OP_FORWARD_BRANCH (CBC_EXT_FINALLY);
        ...
        {
          VM_OPCODE_OP_FORWARD_BRANCH (CBC_JUMP_FORWARD_EXIT_CONTEXT);
