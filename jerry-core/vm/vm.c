...
#define JUMP_NEXT(opcode) \
  group_opcode = opcode; \
  goto switch_next

#else /* USE_COMPUTED_GOTO */

#define DECLARE_LABEL(name) &&name##_##label
...
#define NEXT_INSTRUCTION() \
  goto *labels[VM_OC_DECODE_OPCODE]
...
vm_loop (vm_frame_ctx_t *frame_ctx_p) /**< frame context */
{
  ...
  {
    DECLARE_LABEL(VM_OC_ARG_GET_NONE),
    DECLARE_LABEL(VM_OC_ARG_GET_BRANCH),
    DECLARE_LABEL(VM_OC_ARG_GET_STACK),
    DECLARE_LABEL(VM_OC_ARG_GET_STACK_STACK),

    DECLARE_LABEL(VM_OC_ARG_GET_LITERAL),
    DECLARE_LABEL(VM_OC_ARG_GET_LITERAL_LITERAL),
    DECLARE_LABEL(VM_OC_ARG_GET_STACK_LITERAL),
    DECLARE_LABEL(VM_OC_ARG_GET_THIS_LITERAL),

    DECLARE_LABEL(VM_OC_DECODE_OPCODE),
    DECLARE_LABEL(VM_OC_PUT_RESULT),

    DECLARE_LABEL(VM_OC_POP),
    DECLARE_LABEL(VM_OC_POP_BLOCK),
    DECLARE_LABEL(VM_OC_PUSH),
    DECLARE_LABEL(VM_OC_PUSH_TWO),
    DECLARE_LABEL(VM_OC_PUSH_THREE),
    DECLARE_LABEL(VM_OC_PUSH_UNDEFINED),
    DECLARE_LABEL(VM_OC_PUSH_TRUE),
    DECLARE_LABEL(VM_OC_PUSH_FALSE),
    DECLARE_LABEL(VM_OC_PUSH_NULL),
    DECLARE_LABEL(VM_OC_PUSH_THIS),
    DECLARE_LABEL(VM_OC_PUSH_0),
    DECLARE_LABEL(VM_OC_PUSH_POS_BYTE),
    DECLARE_LABEL(VM_OC_PUSH_NEG_BYTE),
    DECLARE_LABEL(VM_OC_PUSH_LIT_0),
    DECLARE_LABEL(VM_OC_PUSH_LIT_POS_BYTE),
    DECLARE_LABEL(VM_OC_PUSH_LIT_NEG_BYTE),
    DECLARE_LABEL(VM_OC_PUSH_OBJECT),
    DECLARE_LABEL(VM_OC_PUSH_NAMED_FUNC_EXPR),
    DECLARE_LABEL(VM_OC_SET_PROPERTY),

    DECLARE_LABEL(VM_OC_SET_GETTER),
    DECLARE_LABEL(VM_OC_SET_SETTER),
    DECLARE_LABEL(VM_OC_PUSH_ARRAY),
    DECLARE_LABEL(VM_OC_PUSH_ELISON),
    DECLARE_LABEL(VM_OC_APPEND_ARRAY),
    DECLARE_LABEL(VM_OC_IDENT_REFERENCE),
    DECLARE_LABEL(VM_OC_PROP_REFERENCE),
    DECLARE_LABEL(VM_OC_PROP_GET),

    /* These eight opcodes must be in this order. */
    DECLARE_LABEL(VM_OC_PROP_PRE_INCR),
    DECLARE_LABEL(VM_OC_PROP_PRE_DECR),
    DECLARE_LABEL(VM_OC_PROP_POST_INCR),
    DECLARE_LABEL(VM_OC_PROP_POST_DECR),
    DECLARE_LABEL(VM_OC_PRE_INCR),
    DECLARE_LABEL(VM_OC_PRE_DECR),
    DECLARE_LABEL(VM_OC_POST_INCR),
    DECLARE_LABEL(VM_OC_POST_DECR),

    DECLARE_LABEL(VM_OC_PROP_DELETE),
    DECLARE_LABEL(VM_OC_DELETE),

    DECLARE_LABEL(VM_OC_MOV_IDENT),
    DECLARE_LABEL(VM_OC_ASSIGN),
    DECLARE_LABEL(VM_OC_ASSIGN_PROP),
    DECLARE_LABEL(VM_OC_ASSIGN_PROP_THIS),

    DECLARE_LABEL(VM_OC_RETURN),
    DECLARE_LABEL(VM_OC_THROW),
    DECLARE_LABEL(VM_OC_THROW_REFERENCE_ERROR),

    DECLARE_LABEL(VM_OC_EVAL),
    DECLARE_LABEL(VM_OC_CALL),
    DECLARE_LABEL(VM_OC_NEW),
    DECLARE_LABEL(VM_OC_RESOLVE_BASE_FOR_CALL),
    DECLARE_LABEL(VM_OC_ERROR),

    DECLARE_LABEL(VM_OC_JUMP),
#if ENABLED (JERRY_ESNEXT)
    DECLARE_LABEL(VM_OC_BRANCH_IF_NULLISH),
#endif /* ENABLED (JERRY_ESNEXT) */
    DECLARE_LABEL(VM_OC_BRANCH_IF_STRICT_EQUAL),

    /* These four opcodes must be in this order. */
    DECLARE_LABEL(VM_OC_BRANCH_IF_TRUE),
    DECLARE_LABEL(VM_OC_BRANCH_IF_FALSE),
    DECLARE_LABEL(VM_OC_BRANCH_IF_LOGICAL_TRUE),
    DECLARE_LABEL(VM_OC_BRANCH_IF_LOGICAL_FALSE),

    DECLARE_LABEL(VM_OC_PLUS),
    DECLARE_LABEL(VM_OC_MINUS),
    DECLARE_LABEL(VM_OC_NOT),
    DECLARE_LABEL(VM_OC_BIT_NOT),
    DECLARE_LABEL(VM_OC_VOID),
    DECLARE_LABEL(VM_OC_TYPEOF_IDENT),
    DECLARE_LABEL(VM_OC_TYPEOF),

    DECLARE_LABEL(VM_OC_ADD),
    DECLARE_LABEL(VM_OC_SUB),
    DECLARE_LABEL(VM_OC_MUL),
    DECLARE_LABEL(VM_OC_DIV),
    DECLARE_LABEL(VM_OC_MOD),
#if ENABLED (JERRY_ESNEXT)
    DECLARE_LABEL(VM_OC_EXP),
#endif /* ENABLED (JERRY_ESNEXT) */

    DECLARE_LABEL(VM_OC_EQUAL),
    DECLARE_LABEL(VM_OC_NOT_EQUAL),
    DECLARE_LABEL(VM_OC_STRICT_EQUAL),
    DECLARE_LABEL(VM_OC_STRICT_NOT_EQUAL),
    DECLARE_LABEL(VM_OC_LESS),
    DECLARE_LABEL(VM_OC_GREATER),
    DECLARE_LABEL(VM_OC_LESS_EQUAL),
    DECLARE_LABEL(VM_OC_GREATER_EQUAL),
    DECLARE_LABEL(VM_OC_IN),
    DECLARE_LABEL(VM_OC_INSTANCEOF),

    DECLARE_LABEL(VM_OC_BIT_OR),
    DECLARE_LABEL(VM_OC_BIT_XOR),
    DECLARE_LABEL(VM_OC_BIT_AND),
    DECLARE_LABEL(VM_OC_LEFT_SHIFT),
    DECLARE_LABEL(VM_OC_RIGHT_SHIFT),
    DECLARE_LABEL(VM_OC_UNS_RIGHT_SHIFT),

    DECLARE_LABEL(VM_OC_BLOCK_CREATE_CONTEXT),
    DECLARE_LABEL(VM_OC_WITH),
    DECLARE_LABEL(VM_OC_FOR_IN_INIT),
    DECLARE_LABEL(VM_OC_FOR_IN_GET_NEXT),
    DECLARE_LABEL(VM_OC_FOR_IN_HAS_NEXT),

    DECLARE_LABEL(VM_OC_TRY),
    DECLARE_LABEL(VM_OC_CATCH),
    DECLARE_LABEL(VM_OC_FINALLY),
    DECLARE_LABEL(VM_OC_CONTEXT_END),
    DECLARE_LABEL(VM_OC_JUMP_AND_EXIT_CONTEXT),

    DECLARE_LABEL(VM_OC_CREATE_BINDING),
#if ENABLED (JERRY_SNAPSHOT_EXEC)
    DECLARE_LABEL(VM_OC_SET_BYTECODE_PTR),
#endif /* ENABLED (JERRY_SNAPSHOT_EXEC) */
    DECLARE_LABEL(VM_OC_VAR_EVAL),
#if ENABLED (JERRY_ESNEXT)
    DECLARE_LABEL(VM_OC_EXT_VAR_EVAL),
#endif /* ENABLED (JERRY_ESNEXT) */
    DECLARE_LABEL(VM_OC_INIT_ARG_OR_FUNC),

#if ENABLED (JERRY_DEBUGGER)
    DECLARE_LABEL(VM_OC_BREAKPOINT_ENABLED),
    DECLARE_LABEL(VM_OC_BREAKPOINT_DISABLED),
#endif /* ENABLED (JERRY_DEBUGGER) */
#if ENABLED (JERRY_LINE_INFO)
    DECLARE_LABEL(VM_OC_LINE),
#endif /* ENABLED (JERRY_LINE_INFO) */
#if ENABLED (JERRY_ESNEXT)
    DECLARE_LABEL(VM_OC_CHECK_VAR),
    DECLARE_LABEL(VM_OC_CHECK_LET),
    DECLARE_LABEL(VM_OC_ASSIGN_LET_CONST),
    DECLARE_LABEL(VM_OC_INIT_BINDING),
    DECLARE_LABEL(VM_OC_THROW_CONST_ERROR),
    DECLARE_LABEL(VM_OC_THROW_SYNTAX_ERROR),
    DECLARE_LABEL(VM_OC_COPY_TO_GLOBAL),
    DECLARE_LABEL(VM_OC_COPY_FROM_ARG),
    DECLARE_LABEL(VM_OC_CLONE_CONTEXT),
    DECLARE_LABEL(VM_OC_COPY_DATA_PROPERTIES),
    DECLARE_LABEL(VM_OC_SET_COMPUTED_PROPERTY),

    DECLARE_LABEL(VM_OC_FOR_OF_INIT),
    DECLARE_LABEL(VM_OC_FOR_OF_GET_NEXT),
    DECLARE_LABEL(VM_OC_FOR_OF_HAS_NEXT),
    DECLARE_LABEL(VM_OC_FOR_AWAIT_OF_INIT),
    DECLARE_LABEL(VM_OC_FOR_AWAIT_OF_HAS_NEXT),

    DECLARE_LABEL(VM_OC_LOCAL_EVAL),
    DECLARE_LABEL(VM_OC_SUPER_CALL),
    DECLARE_LABEL(VM_OC_PUSH_CLASS_ENVIRONMENT),
    DECLARE_LABEL(VM_OC_PUSH_IMPLICIT_CTOR),
    DECLARE_LABEL(VM_OC_INIT_CLASS),
    DECLARE_LABEL(VM_OC_FINALIZE_CLASS),
    DECLARE_LABEL(VM_OC_PUSH_SUPER_CONSTRUCTOR),
    DECLARE_LABEL(VM_OC_RESOLVE_LEXICAL_THIS),
    DECLARE_LABEL(VM_OC_SUPER_REFERENCE),
    DECLARE_LABEL(VM_OC_SET_HOME_OBJECT),
    DECLARE_LABEL(VM_OC_OBJECT_LITERAL_HOME_ENV),
    DECLARE_LABEL(VM_OC_SET_FUNCTION_NAME),

    DECLARE_LABEL(VM_OC_PUSH_SPREAD_ELEMENT),
    DECLARE_LABEL(VM_OC_GET_ITERATOR),
    DECLARE_LABEL(VM_OC_ITERATOR_STEP),
    DECLARE_LABEL(VM_OC_ITERATOR_CLOSE),
    DECLARE_LABEL(VM_OC_DEFAULT_INITIALIZER),
    DECLARE_LABEL(VM_OC_REST_INITIALIZER),
    DECLARE_LABEL(VM_OC_INITIALIZER_PUSH_PROP),
    DECLARE_LABEL(VM_OC_SPREAD_ARGUMENTS),
    DECLARE_LABEL(VM_OC_CREATE_GENERATOR),
    DECLARE_LABEL(VM_OC_YIELD),
    DECLARE_LABEL(VM_OC_ASYNC_YIELD),
    DECLARE_LABEL(VM_OC_ASYNC_YIELD_ITERATOR),
    DECLARE_LABEL(VM_OC_AWAIT),
    DECLARE_LABEL(VM_OC_GENERATOR_AWAIT),
    DECLARE_LABEL(VM_OC_EXT_RETURN),
    DECLARE_LABEL(VM_OC_ASYNC_EXIT),
    DECLARE_LABEL(VM_OC_STRING_CONCAT),
    DECLARE_LABEL(VM_OC_GET_TEMPLATE_OBJECT),
    DECLARE_LABEL(VM_OC_PUSH_NEW_TARGET),
    DECLARE_LABEL(VM_OC_REQUIRE_OBJECT_COERCIBLE),
    DECLARE_LABEL(VM_OC_ASSIGN_SUPER),
    DECLARE_LABEL(VM_OC_SET__PROTO__),
#endif /* ENABLED (JERRY_ESNEXT) */
    DECLARE_LABEL(VM_OC_NONE),
  };
#undef DECLARE_LABEL
#endif /* USE_COMPUTED_GOTO */
  ...
  ecma_value_t left_value = ECMA_VALUE_UNDEFINED;
  ecma_value_t right_value = ECMA_VALUE_UNDEFINED;
  ecma_value_t result = ECMA_VALUE_EMPTY;
...
decode_next:
        ...
        JUMP_NEXT (VM_OC_GET_ARGS_OPCODE (opcode_data));
      }
      OPCODE (VM_OC_ARG_GET_NONE):
      {
        JUMP_NEXT (VM_OC_GROUP_GET_INDEX (opcode_data));
      }
      OPCODE (VM_OC_ARG_GET_BRANCH):
      {
      ...
      OPCODE (VM_OC_ARG_GET_LITERAL):
      OPCODE (VM_OC_ARG_GET_LITERAL_LITERAL):
      {
        uint16_t literal_index;
        READ_LITERAL_INDEX (literal_index);
        READ_LITERAL (literal_index, left_value);
#ifdef USE_COMPUTED_GOTO
        uint32_t group_opcode = VM_OC_GET_ARGS_OPCODE (opcode_data);
#endif /* USE_COMPUTED_GOTO */
        if (group_opcode != VM_OC_ARG_GET_LITERAL)
        {
          JERRY_ASSERT (group_opcode != VM_OC_ARG_GET_STACK_LITERAL
                        || stack_top_p > VM_GET_REGISTERS (frame_ctx_p) + register_end);

          PRE_CONDITION (VM_OC_ARG_GET_THIS_LITERAL, left_value = ecma_copy_value (frame_ctx_p->this_binding))
          PRE_CONDITION (VM_OC_ARG_GET_STACK_LITERAL, left_value = *(--stack_top_p))
      ...
      OPCODE (VM_OC_PUSH_TWO):
      {
        *stack_top_p++ = left_value;
        *stack_top_p++ = right_value;
        NEXT_INSTRUCTION ();
      }
      OPCODE (VM_OC_PUSH_THREE):
      {
        uint16_t literal_index;
      ...
      OPCODE (VM_OC_PUSH_UNDEFINED):
      {
        *stack_top_p++ = ECMA_VALUE_UNDEFINED;
        NEXT_INSTRUCTION ();
      }
      OPCODE (VM_OC_PUSH_TRUE):
      {
        *stack_top_p++ = ECMA_VALUE_TRUE;
        NEXT_INSTRUCTION ();
      }
      OPCODE (VM_OC_PUSH_FALSE):
      {
        *stack_top_p++ = ECMA_VALUE_FALSE;
        NEXT_INSTRUCTION ();
      }
      OPCODE (VM_OC_PUSH_NULL):
      {
        *stack_top_p++ = ECMA_VALUE_NULL;
        NEXT_INSTRUCTION ();
      }
      OPCODE (VM_OC_PUSH_THIS):
      {
      ...
      OPCODE (VM_OC_PUSH_LIT_POS_BYTE):
      {
        ecma_integer_value_t number = *byte_code_p++;
        stack_top_p[0] = left_value;
      ...
      OPCODE (VM_OC_PUSH_LIT_NEG_BYTE):
      {
        ecma_integer_value_t number = *byte_code_p++;
        stack_top_p[0] = left_value;
        stack_top_p[1] = ecma_make_integer_value (-(number + 1));
      ...
      OPCODE (VM_OC_PUSH_NAMED_FUNC_EXPR):
      {
      ...
      OPCODE (VM_OC_COPY_DATA_PROPERTIES):
      {
        result = *(--stack_top_p);
      ...
      OPCODE (VM_OC_SET_COMPUTED_PROPERTY):
      {
        /* Swap values. */
      ...
      OPCODE (VM_OC_SET_GETTER):
      OPCODE (VM_OC_SET_SETTER):
      {
        JERRY_ASSERT ((opcode_data >> VM_OC_NON_STATIC_SHIFT) <= 0x1);
      ...
      OPCODE (VM_OC_FINALIZE_CLASS):
      {
        opfunc_finalize_class (frame_ctx_p, &stack_top_p, left_value);
        goto free_left_value;
      }
      OPCODE (VM_OC_PUSH_SUPER_CONSTRUCTOR):
      {
      ...
      OPCODE (VM_OC_RESOLVE_LEXICAL_THIS):
      {
      ...
      OPCODE (VM_OC_OBJECT_LITERAL_HOME_ENV):
      {
      ...
      OPCODE (VM_OC_SET_FUNCTION_NAME):
      {
        char *prefix_p = NULL;
      ...
      OPCODE (VM_OC_PUSH_SPREAD_ELEMENT):
      {
        *stack_top_p++ = ECMA_VALUE_SPREAD_ELEMENT;
        NEXT_INSTRUCTION ();
      }
      OPCODE (VM_OC_GET_ITERATOR):
      {
      ...
      OPCODE (VM_OC_DEFAULT_INITIALIZER):
      {
        JERRY_ASSERT (stack_top_p > VM_GET_REGISTERS (frame_ctx_p) + register_end);
      ...
      OPCODE (VM_OC_INITIALIZER_PUSH_PROP):
      {
      ...
      OPCODE (VM_OC_ASYNC_YIELD_ITERATOR):
      {
        ecma_extended_object_t *async_generator_object_p = VM_GET_EXECUTABLE_OBJECT (frame_ctx_p);
      ...
      OPCODE (VM_OC_GET_TEMPLATE_OBJECT):
      {
      ...
      OPCODE (VM_OC_REQUIRE_OBJECT_COERCIBLE):
      {
...
#endif /* ENABLED (JERRY_ESNEXT) */
      OPCODE (VM_OC_PUSH_ELISON):
      {
        *stack_top_p++ = ECMA_VALUE_ARRAY_HOLE;
        NEXT_INSTRUCTION ();
      }
      OPCODE (VM_OC_APPEND_ARRAY):
      {
      ...
      OPCODE (VM_OC_PROP_PRE_INCR):
      OPCODE (VM_OC_PROP_PRE_DECR):
      OPCODE (VM_OC_PROP_POST_INCR):
      OPCODE (VM_OC_PROP_POST_DECR):
      {
      ...
      OPCODE (VM_OC_PRE_INCR):
      OPCODE (VM_OC_PRE_DECR):
      OPCODE (VM_OC_POST_INCR):
      OPCODE (VM_OC_POST_DECR):
      {
      ...
      OPCODE (VM_OC_THROW_REFERENCE_ERROR):
      {
      ...
      OPCODE (VM_OC_RESOLVE_BASE_FOR_CALL):
      {
      ...
      OPCODE (VM_OC_BRANCH_IF_STRICT_EQUAL):
      {
        ecma_value_t value = *(--stack_top_p);
      ...
      OPCODE (VM_OC_BRANCH_IF_TRUE):
      OPCODE (VM_OC_BRANCH_IF_FALSE):
      OPCODE (VM_OC_BRANCH_IF_LOGICAL_TRUE):
      OPCODE (VM_OC_BRANCH_IF_LOGICAL_FALSE):
      {
...
#if ENABLED (JERRY_ESNEXT)
      OPCODE (VM_OC_BRANCH_IF_NULLISH):
      {
        left_value = stack_top_p[-1];
      ...
      OPCODE (VM_OC_BLOCK_CREATE_CONTEXT):
      {
#if ENABLED (JERRY_ESNEXT)
      ...
      OPCODE (VM_OC_FOR_AWAIT_OF_INIT):
      {
        ecma_value_t value = *(--stack_top_p);
      ...
      OPCODE (VM_OC_FOR_AWAIT_OF_HAS_NEXT):
      {
        JERRY_ASSERT (VM_GET_REGISTERS (frame_ctx_p) + register_end + frame_ctx_p->context_depth == stack_top_p);
      ...
      OPCODE (VM_OC_JUMP_AND_EXIT_CONTEXT):
      {
        JERRY_ASSERT (VM_GET_REGISTERS (frame_ctx_p) + register_end + frame_ctx_p->context_depth == stack_top_p);
        JERRY_ASSERT (!jcontext_has_pending_exception ());
...
#if ENABLED (JERRY_DEBUGGER)
      OPCODE (VM_OC_BREAKPOINT_ENABLED):
      {
      ...
      OPCODE (VM_OC_BREAKPOINT_DISABLED):
      {
        if (JERRY_CONTEXT (debugger_flags) & JERRY_DEBUGGER_VM_IGNORE)
        {
          NEXT_INSTRUCTION ();
