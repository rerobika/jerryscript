...
/**
 * Function to make an empty property reference
 *
 * Note:
 *   if the property reference has the ECMA_PROP_DESC_FOUND, it should be freed with
...
/**
 * Check if the given property reference is enumerable
 *
 * @return bool
 */
bool
...
/**
 * Check if the given property reference is configurable
 *
 * @return bool
 */
bool
...
/**
 * Check if the given property reference is writable
 *
 * @return bool
 */
bool
...
/**
 * Check if the given property reference is a data property
 *
 * @return bool
 */
bool
...
/**
 * Check if the property reference is found
 *
 * @return bool
 */
bool
...
/**
 * Check if the property reference is an error
 *
 * @return bool
 */
bool
...
/**
 * Get the value from the property reference
 *
...
/**
 * Get the getter function object pointer from the property reference
 *
 * @return getter object pointer
 */
ecma_object_t *
...
/**
 * Get the setter function object pointer from the property reference
 *
 * @return setter object pointer
 */
ecma_object_t *
                              ...
                              ecma_value_t receiver) /* receiver */
{
  ...
  return call_call_internal_method (getter_p, receiver, NULL, 0);
} /* ecma_property_descriptor_get */

/**
 * Set the property reference's configurable and enumerable flags based on the 'flags' argument
 */
void
