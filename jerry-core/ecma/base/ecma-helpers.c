                      ...
                      ecma_property_value_t value) /**< property value */
{
  ...
  uint8_t name_type;
  property_list_p[index].name_cp = ecma_string_to_property_name (name_p, &name_type);
  property_list_p[index].type_flags = (uint8_t) (type_and_flags | name_type);
  property_list_p[index].u = value;
  property_list_p[index].prop_count = 0;
                      ...
                      ecma_property_t *property_del_p) /**< property value reference */
{
  ...
  ecma_property_t *property_list_p = ECMA_GET_NON_NULL_POINTER (ecma_property_t, cur_prop_cp);
