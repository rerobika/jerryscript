...
typedef enum
{
  ...
  ECMA_OBJECT_TYPE_PADDING, /**< unused type */
...
typedef void (*ecma_internal_delete_builtin_property_cb_t) (ecma_object_t *, ecma_string_t *);
typedef void (*ecma_internal_padding_cb_t) (void);
...
typedef struct
{
  ...
  ecma_internal_delete_builtin_property_cb_t delete_builtin_property;
  ecma_internal_padding_cb_t padding;
