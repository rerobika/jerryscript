                                              ...
                                              ecma_value_t arg2) /**< second argument */
{
  ...
  {
    return call_call_internal_method (func_obj_p, arg1, NULL, 0);
  }
  ...
  if (ecma_is_value_empty (ret_value))
  {
    ...
    ret_value = call_call_internal_method (func_obj_p, arg1, arguments_list_p, (uint32_t) length);
  }
                                             ...
                                             uint32_t arguments_number) /**< number of arguments */
{
  if (arguments_number == 0)
  {
    ...
    return call_call_internal_method (func_obj_p, ECMA_VALUE_UNDEFINED, NULL, 0);
  }

  return call_call_internal_method (func_obj_p,
                                    arguments_list_p[0],
                                    arguments_list_p + 1,
                                             ...
                                             uint32_t arguments_number) /**< number of arguments */
{
...
#else /* JERRY_ESNEXT */
  prototype_obj_p = call_get_prototype_of_internal_method (this_arg_obj_p);
  ...
  ecma_property_descriptor_t prop_desc = call_get_own_property_internal_method (this_arg_obj_p, len_string);
  ...
  if (ecma_property_descriptor_found (&prop_desc))
  {
    ...
    ecma_value_t len_value =
      call_get_internal_method (this_arg_obj_p, len_string, ecma_make_object_value (this_arg_obj_p));
