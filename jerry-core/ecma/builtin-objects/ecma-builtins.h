...
void ecma_builtin_function_delete_built_in_property (ecma_object_t *object_p, ecma_string_t *property_name_p);
...
void ecma_builtin_object_detele_built_in_property (ecma_object_t *object_p, ecma_string_t *property_name_p);
...
#define ECMA_BUILT_IN_OBJ_VTABLE                                                        \
  [ECMA_OBJECT_TYPE_BUILT_IN_GENERAL] = { ecma_ordinary_object_get_prototype_of,        \
                                          ...
                                          ecma_builtin_object_detele_built_in_property, \
                                          NULL }
