                                        ...
                                        ecma_string_t *name_p) /**< property name */
{
  ...
  /* 4. */
  ecma_func_args_t func_args = ecma_op_make_call_args (reviver_p,
                                      ...
                                      ecma_string_t *key_p) /**< property key*/
{
  ...
  if (ecma_is_value_object (value))
  {
    ...
    if (ecma_op_is_callable (to_json))
    {
      ...
      ecma_func_args_t func_args = ecma_op_make_call_args (to_json_obj_p, value, &key_value, 1);
  ...
  if (context_p->replacer_function_p)
  {
    ...
    ecma_func_args_t func_args = ecma_op_make_call_args (context_p->replacer_function_p, holder_value, args, 2);
    ecma_value_t result = ecma_op_function_call (&func_args);
