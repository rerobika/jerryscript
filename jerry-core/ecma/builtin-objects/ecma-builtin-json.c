                                        ...
                                        ecma_string_t *name_p) /**< property name */
{
  ...
  /* 1. */
  ecma_value_t value = call_get_internal_method (holder_p, name_p, ecma_make_object_value (holder_p));
  ...
  /* 4. */
  ecma_value_t ret_value = call_call_internal_method (reviver_p, ecma_make_object_value (holder_p), arguments_list, 2);
  ecma_free_value (value);
  return ret_value;
                                                ...
                                                ecma_string_t *prop_name) /**< property name */
{
  ...
  if (ecma_is_value_undefined (new_element))
  {
    ...
    ecma_value_t delete_val = call_delete_internal_method (object_p, prop_name, false);
...
{
  /* 1. */
  ecma_value_t value = call_get_internal_method (holder_p, key_p, ecma_make_object_value (holder_p));
  ...
  if (ecma_is_value_object (value) || ecma_is_value_bigint (value))
  {
    ...
    ecma_value_t to_json =
      call_get_internal_method (value_obj_p, ecma_get_magic_string (LIT_MAGIC_STRING_TO_JSON_UL), value);
    ...
    if (ecma_op_is_callable (to_json))
    {
      ...
      ecma_value_t result = call_call_internal_method (to_json_obj_p, value, call_args, 1);
      ecma_free_value (value);
  ...
  if (context_p->replacer_function_p)
  {
    ...
    ecma_value_t result = call_call_internal_method (context_p->replacer_function_p, holder_value, call_args, 2);
    ecma_free_value (value);
