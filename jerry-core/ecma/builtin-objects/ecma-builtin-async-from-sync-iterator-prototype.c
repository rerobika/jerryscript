                                                    ...
                                                    lit_magic_string_id_t method_id) /**< method id */
{
  ...
  if (ecma_is_value_undefined (method))
  {
    ...
    ecma_value_t resolve =
      call_call_internal_method (ecma_get_object_from_value (func_obj), ECMA_VALUE_UNDEFINED, &call_arg, arg_size);
  ...
  /* 8. */
  ecma_value_t call_result = call_validated_call_internal_method (method, sync_iterator, &call_arg, arg_size);
  ...
  if (!ecma_is_value_object (call_result))
  {
    ...
    /* 10.a. */
    ecma_value_t reject = call_call_internal_method (ecma_get_object_from_value (capability_p->reject),
                                                     ECMA_VALUE_UNDEFINED,
                                                     &type_error,
                                                     1);
