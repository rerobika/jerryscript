...
/**
 * Handle [[Call]]/[[Construct]] of built-in WeakSet object
 *
 * @return ecma value
 */
ecma_value_t
ecma_builtin_weakset_dispatch (ecma_func_args_t *func_args_p) /**< function arguments */
{
