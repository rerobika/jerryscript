                                                ...
                                                ecma_number_t length) /**< new length */
{
  ...
  ecma_value_t ret_value = call_set_internal_method (object,
                                          ...
                                          ecma_length_t length) /**< object's length */
{
  ...
  for (ecma_length_t index = 0; index < arguments_number; index++, n++)
  {
    ...
    ecma_value_t put_value =
      call_set_internal_method (obj_p, index_str_p, argument_list_p[index], ecma_make_object_value (obj_p), true);
                                             ...
                                             ecma_length_t len) /**< object's length */
{
  ...
  for (ecma_length_t lower = 0; lower < middle; lower++)
  {
    ...
    ecma_value_t has_lower = call_has_property_internal_method (obj_p, lower_str_p);
    ...
    if (lower_exist)
    {
      lower_value = call_get_internal_method (obj_p, lower_str_p, obj_value);
    ...
    ecma_value_t has_upper = call_has_property_internal_method (obj_p, upper_str_p);
    ...
    if (upper_exist)
    {
      upper_value = call_get_internal_method (obj_p, upper_str_p, obj_value);
...
#else /* !JERRY_ESNEXT */
    ecma_value_t lower_value = call_get_internal_method (obj_p, lower_str_p, obj_value);
    ...
    ecma_value_t upper_value = call_get_internal_method (obj_p, upper_str_p, obj_value);
    ...
    {
      ecma_value_t outer_put_value = call_set_internal_method (obj_p, lower_str_p, upper_value, obj_value, true);
      ...
      ecma_value_t inner_put_value = call_set_internal_method (obj_p, upper_str_p, lower_value, obj_value, true);
    ...
    {
      ecma_value_t put_value = call_set_internal_method (obj_p, lower_str_p, upper_value, obj_value, true);
      ...
      ecma_value_t del_value = call_delete_internal_method (obj_p, upper_str_p, true);
    ...
    {
      ecma_value_t del_value = call_delete_internal_method (obj_p, lower_str_p, true);
      ...
      ecma_value_t put_value = call_set_internal_method (obj_p, upper_str_p, lower_value, obj_value, true);
                                                         ...
                                                         ecma_object_t *array_buffer_p) /**< arrayBuffer */
{
  ...
  else
  {
    ...
    ecma_value_t call_value = call_call_internal_method (comparefn_obj_p, ECMA_VALUE_UNDEFINED, compare_args, 2);
                                          ...
                                          ecma_object_t *obj_p) /**< object */
{
  ...
  for (uint32_t i = 0; i < len; i++)
  {
    ...
    ecma_property_descriptor_t prop_desc = call_get_own_property_internal_method (obj_p, prop_name_p);
  ...
  for (uint32_t i = 0; i < array_index_props_p->item_count; i++)
  {
    ...
    ecma_value_t index_value = call_get_internal_method (obj_p, property_name_p, ecma_make_object_value (obj_p));
...
clean_up:
  ...
  for (uint32_t i = 0; i < array_index_props_p->item_count; i++)
  {
    ...
    {
      ecma_value_t del_value = call_delete_internal_method (obj_p, property_name_p, true);
  ...
  if (should_iterate)
  {
    ...
    for (ecma_length_t k = len; k > 0; k--)
    {
      ...
      if (ecma_is_value_found (get_value))
      {
        ...
        operation_value =
          call_set_internal_method (obj_p, index_str_p, get_value, ecma_make_object_value (obj_p), true);
        ecma_free_value (get_value);
      }
      else
      {
        /* ES5.1:6.e.i, ES11:4.c.v. */
        operation_value = call_delete_internal_method (obj_p, index_str_p, true);
      }
...

{
  ...
  for (ecma_length_t index = 0; index < len; index++)
  {
    ...
    if (ecma_is_value_found (get_value))
    {
      ...
      /* 7.c.ii */
      ecma_value_t call_value = call_call_internal_method (func_object_p, arg2, call_args, 3);
                                         ...
                                         ecma_length_t len) /**< object's length */
{
  ...
  for (ecma_length_t index = 0; index < len; index++)
  {
    ...
    if (ecma_is_value_found (current_value))
    {
      ...
      ecma_value_t mapped_value = call_call_internal_method (func_object_p, arg2, call_args, 3);
                                ...
                                ecma_length_t len) /**< object's length */
{
  ...
  for (; index < len; index++)
  {
    ...
    if (ecma_is_value_found (current_value))
    {
      ...
      ecma_value_t call_value = call_call_internal_method (func_object_p, ECMA_VALUE_UNDEFINED, call_args, 4);
                                          ...
                                          ecma_length_t len) /**< object's length */
{
  ...
  for (ecma_length_t index = 0; index < len; index++)
  {
    ...
    ecma_value_t call_value = call_call_internal_method (func_object_p, predicate_this_arg, call_args, 3);
  ...
  for (ecma_length_t source_index = 0; source_index < source_len; source_index++)
  {
    ...
    if (!ecma_is_value_undefined (mapped_value))
    {
      ...
      ecma_value_t temp_element =
        call_call_internal_method (ecma_get_object_from_value (mapped_value), thisArg, args, 3);
