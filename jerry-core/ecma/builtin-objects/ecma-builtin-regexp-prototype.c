                                         ...
                                         ecma_value_t string_arg) /**< source string */
{
  ...
  ecma_value_t matcher = call_construct_internal_method (constructor_obj_p, constructor_obj_p, match_args, 2);
  ...
  ecma_value_t set = call_set_internal_method (matcher_obj_p,
                                               ecma_get_magic_string (LIT_MAGIC_STRING_LASTINDEX_UL),
                                               last_index_value,
