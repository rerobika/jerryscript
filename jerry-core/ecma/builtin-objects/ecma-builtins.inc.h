...
BUILTIN (ECMA_BUILTIN_ID_DATE_PROTOTYPE, ECMA_OBJECT_TYPE_CLASS, ECMA_BUILTIN_ID_OBJECT_PROTOTYPE, true, date_prototype)
#endif /* JERRY_BUILTIN_DATE */
...
BUILTIN (ECMA_BUILTIN_ID_MATH, ECMA_OBJECT_TYPE_GENERAL, ECMA_BUILTIN_ID_OBJECT_PROTOTYPE, true, math)
#endif /* JERRY_BUILTIN_MATH */

#if JERRY_BUILTIN_REFLECT

/* The Reflect object (26.1) */
BUILTIN (ECMA_BUILTIN_ID_REFLECT, ECMA_OBJECT_TYPE_GENERAL, ECMA_BUILTIN_ID_OBJECT_PROTOTYPE, true, reflect)
#endif /* JERRY_BUILTIN_REFLECT */

#if JERRY_BUILTIN_JSON
/* The JSON object (15.12) */
BUILTIN (ECMA_BUILTIN_ID_JSON, ECMA_OBJECT_TYPE_GENERAL, ECMA_BUILTIN_ID_OBJECT_PROTOTYPE, true, json)
#endif /* JERRY_BUILTIN_JSON */

#if JERRY_BUILTIN_DATE
/* The Date object (15.9.3) */
BUILTIN_ROUTINE (ECMA_BUILTIN_ID_DATE, ECMA_OBJECT_TYPE_NATIVE_FUNCTION, ECMA_BUILTIN_ID_FUNCTION_PROTOTYPE, true, date)
#endif /* JERRY_BUILTIN_DATE */
...
BUILTIN (ECMA_BUILTIN_ID_MAP_PROTOTYPE, ECMA_OBJECT_TYPE_GENERAL, ECMA_BUILTIN_ID_OBJECT_PROTOTYPE, true, map_prototype)

/* The Map routine (ECMA-262 v6, 23.1.1.1) */
BUILTIN_ROUTINE (ECMA_BUILTIN_ID_MAP, ECMA_OBJECT_TYPE_NATIVE_FUNCTION, ECMA_BUILTIN_ID_FUNCTION_PROTOTYPE, true, map)
...
BUILTIN (ECMA_BUILTIN_ID_SET_PROTOTYPE, ECMA_OBJECT_TYPE_GENERAL, ECMA_BUILTIN_ID_OBJECT_PROTOTYPE, true, set_prototype)

/* The Set routine (ECMA-262 v6, 23.1.1.1) */
BUILTIN_ROUTINE (ECMA_BUILTIN_ID_SET, ECMA_OBJECT_TYPE_NATIVE_FUNCTION, ECMA_BUILTIN_ID_FUNCTION_PROTOTYPE, true, set)
...
BUILTIN (ECMA_BUILTIN_ID_GENERATOR, ECMA_OBJECT_TYPE_GENERAL, ECMA_BUILTIN_ID_FUNCTION_PROTOTYPE, true, generator)
