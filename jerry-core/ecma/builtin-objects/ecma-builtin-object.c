                                             ...
                                             ecma_value_t arg2) /**< routine's second argument */
{
  ...
  /* 5. */
  ecma_value_t status = call_set_prototype_of_internal_method (obj_p, arg2);
...
{
  /* 3. */
  ecma_value_t prevent_extensions_res = call_prevent_extensions_internal_method (obj_p);
  ...
  /* 6. */
  ecma_collection_t *props_p = call_own_property_keys_internal_method (obj_p, JERRY_PROPERTY_FILTER_ALL);
  ...
  if (is_seal)
  {
    ...
    for (uint32_t i = 0; i < props_p->item_count; i++)
    {
      ...
      ecma_property_descriptor_t prop_desc = call_get_own_property_internal_method (obj_p, property_name_p);
      ...
      ecma_value_t define_own_prop_ret =
        call_define_own_property_internal_method (obj_p, property_name_p, &define_prop_desc);
...
{
  ecma_value_t status = call_prevent_extensions_internal_method (obj_p);
                                          ...
                                          int mode) /**< routine mode */
{
  ...
  /* 3. */
  ecma_value_t is_extensible = call_is_extensible_internal_method (obj_p);
...
{
  /* 3. */
  ecma_property_descriptor_t prop_desc = call_get_own_property_internal_method (obj_p, name_str_p);
...
{
  /* 2 */
  ecma_collection_t *prop_names_p = call_own_property_keys_internal_method (obj_p, JERRY_PROPERTY_FILTER_ALL);
                                              ...
                                              ecma_value_t arg2) /**< routine's second argument */
{
  ...
  /* 3. */
  ecma_collection_t *prop_names_p = call_own_property_keys_internal_method (props_p, JERRY_PROPERTY_FILTER_ALL);
  ...
  for (uint32_t i = 0; i < prop_names_p->item_count; i++)
  {
    ...
    ecma_property_descriptor_t prop_desc = call_get_own_property_internal_method (props_p, prop_name_p);
    ...
    if (ecma_property_descriptor_found (&prop_desc))
    {
      ...
      {
        ecma_value_t desc_obj = call_get_internal_method (props_p, prop_name_p, props);
  ...
  for (uint32_t i = 0; i < enum_prop_names->item_count; i++)
  {
    ...
    ecma_value_t define_own_prop_ret =
      call_define_own_property_internal_method (obj_p, prop_name_p, &property_descriptors[i]);
                                            ...
                                            ecma_value_t arg3) /**< routine's third argument */
{
  ...
  ecma_value_t define_own_prop_ret = call_define_own_property_internal_method (obj_p, name_str_p, &prop_desc);
                                   ...
                                   uint32_t arguments_list_len) /**< number of arguments */
{
  ...
  for (uint32_t i = 0; i < arguments_list_len && ecma_is_value_empty (ret_value); i++)
  {
    ...
    /* 5.b.iii */
    ecma_collection_t *props_p = call_own_property_keys_internal_method (from_obj_p, JERRY_PROPERTY_FILTER_ALL);
    ...
    for (uint32_t j = 0; (j < props_p->item_count) && ecma_is_value_empty (ret_value); j++)
    {
      ...
      /* 5.c.i-ii */
      ecma_property_descriptor_t prop_desc = call_get_own_property_internal_method (from_obj_p, property_name_p);
      ...
      {
        /* 5.c.iii.1 */
        ecma_value_t prop_value = call_get_internal_method (from_obj_p, property_name_p, from_value);
        ...
        else
        {
          /* 5.c.iii.3 */
          ecma_value_t status =
            call_set_internal_method (target_p, property_name_p, prop_value, ecma_make_object_value (target_p), true);
                                      ...
                                      uint16_t type) /**< routine type */
{
  ...
  ecma_collection_t *props_p = call_own_property_keys_internal_method (obj_p, filter);
                                      ...
                                      uint32_t arguments_number) /**< length of arguments' list */
{
  ...
  else
  {
    ...
    switch (builtin_routine_id)
    {
      ...
      {
        return call_is_extensible_internal_method (obj_p);
      }
      default:
      {
        JERRY_UNREACHABLE ();
