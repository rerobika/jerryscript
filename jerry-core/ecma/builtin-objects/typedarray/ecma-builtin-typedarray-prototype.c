                                                ...
                                                typedarray_routine_mode mode) /**< mode: which routine */
{
  ...
  for (uint32_t index = 0; index < info.length && ecma_is_value_empty (ret_value); index++)
  {
    ...
    ecma_func_args_t func_args = ecma_op_make_call_args (func_object_p, cb_this_arg, args, 3);
                                       ...
                                       ecma_value_t cb_this_arg) /**< this' of the callback function */
{
  ...
  for (uint32_t index = 0; index < src_info.length; index++)
  {
    ...
    ecma_value_t args[] = { get_value, current_index, this_arg };
    ecma_func_args_t func_args = ecma_op_make_call_args (func_object_p, cb_this_arg, args, 3);
    ecma_value_t mapped_value = ecma_op_function_call (&func_args);
                                                         ...
                                                         bool is_right) /**< choose order, true is reduceRight */
{
  ...
  while (true)
  {
    ...
    ecma_func_args_t func_args = ecma_op_make_call_args (func_object_p, ECMA_VALUE_UNDEFINED, args, 4);
    ecma_value_t call_value = ecma_op_function_call (&func_args);
                                            ...
                                            ecma_value_t end) /**< end */
{
  ...
  ecma_object_t *prototype_obj_p = ecma_builtin_get (ecma_typedarray_helper_get_prototype_id (info.id));
  ret_value = ecma_op_create_typedarray (arguments_p,
                                         3,
                                         prototype_obj_p,
                                         ecma_typedarray_helper_get_shift_size (info.id),
                                         info.id);
                                                       ...
                                                       ecma_value_t compare_func) /**< compare function */
{
  ...
  ecma_func_args_t func_args = ecma_op_make_call_args (comparefn_obj_p, ECMA_VALUE_UNDEFINED, compare_args, 2);
  ecma_value_t call_value = ecma_op_function_call (&func_args);
                                                           ...
                                                           uint32_t index) /** array index */
{
  ...
  if (ecma_op_is_callable (func_value))
  {
    ...
    ecma_func_args_t func_args = ecma_op_make_call_args (func_obj, element_obj, NULL, 0);
    ecma_value_t call_value = ecma_op_function_call (&func_args);
