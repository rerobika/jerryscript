                                ...
                                uint32_t arguments_list_len) /**< number of arguments */
{
  ...
  if (!ecma_is_value_undefined (using_iterator))
  {
    ...
    if (ecma_is_constructor (constructor))
    {
      ...
      ecma_value_t array = call_construct_internal_method (constructor_obj_p, constructor_obj_p, NULL, 0);
    ...
    while (true)
    {
      ...
      if (ecma_is_value_false (next))
      {
        ...
        ecma_value_t set_status = call_set_internal_method (array_obj_p,
      ...
      if (mapfn_obj_p != NULL)
      {
        ...
        /* 6.g.vii.3 */
        mapped_value = call_call_internal_method (mapfn_obj_p, call_this_arg, args_p, 2);
...
iterator_cleanup:
  ...
  if (ecma_is_constructor (constructor))
  {
    ...
    ecma_value_t array = call_construct_internal_method (constructor_obj_p, constructor_obj_p, &len_value, 1);
    ecma_free_value (len_value);
                              ...
                              uint32_t arguments_list_len) /**< number of arguments */
{
  ...
  ecma_value_t ret_val = call_construct_internal_method (ecma_get_object_from_value (this_arg),
  ...
  ret_val = call_set_internal_method (obj_p,
                                      ecma_get_magic_string (LIT_MAGIC_STRING_LENGTH),
                                      len,
