                                       ...
                                       uint32_t arguments_number) /**< length of arguments' list */
{
  ...
  if (builtin_routine_id < ECMA_REFLECT_OBJECT_CONSTRUCT)
  {
    ...
    switch (builtin_routine_id)
    {
      case ECMA_REFLECT_OBJECT_GET:
      {
        ...
        ret_value = call_get_internal_method (target_p, name_str_p, receiver);
        break;
      }

      case ECMA_REFLECT_OBJECT_HAS:
      {
        ret_value = call_has_property_internal_method (target_p, name_str_p);
        break;
      }

      case ECMA_REFLECT_OBJECT_DELETE_PROPERTY:
      {
        ret_value = call_delete_internal_method (target_p, name_str_p, false);
        break;
      }
      ...
      default:
      {
        ...
        ret_value = call_set_internal_method (target_p, name_str_p, arguments_list[2], receiver, false);
        break;
      }
    }
  ...
  if (builtin_routine_id == ECMA_REFLECT_OBJECT_OWN_KEYS)
  {
    ...
    /* 2. */
    ecma_collection_t *prop_names = call_own_property_keys_internal_method (target_p, JERRY_PROPERTY_FILTER_ALL);
  ...
  if (builtin_routine_id == ECMA_REFLECT_OBJECT_CONSTRUCT)
  {
    ...
    ecma_value_t ret_value =
      call_construct_internal_method (target_p, new_target_p, coll_p->buffer_p, coll_p->item_count);
  ...
  switch (builtin_routine_id)
  {
    ...
    case ECMA_REFLECT_OBJECT_SET_PROTOTYPE_OF:
    {
      ...
      return call_set_prototype_of_internal_method (obj_p, arguments_list[1]);
    }
    ...
    case ECMA_REFLECT_OBJECT_DEFINE_PROPERTY:
    {
      ...
      ecma_value_t result = call_define_own_property_internal_method (obj_p, name_str_p, &prop_desc);
    ...
    default:
    {
      ...
      ecma_object_t *obj_p = ecma_get_object_from_value (arguments_list[0]);
      return call_prevent_extensions_internal_method (obj_p);
    }
  }
