...
ecma_proxy_object_get_prototype_of (ecma_object_t *obj_p) /**< proxy object */
{
  ...
  {
    ecma_object_t *result = call_get_prototype_of_internal_method (target_obj_p);
  ...
  /* 8. */
  ecma_value_t handler_proto = call_call_internal_method (func_obj_p, handler, &target, 1);
  ...
  /* 11. */
  ecma_value_t extensible_target = call_is_extensible_internal_method (target_obj_p);
  ...
  /* 14. */
  ecma_object_t *target_proto = call_get_prototype_of_internal_method (target_obj_p);
                                    ...
                                    ecma_value_t proto) /**< new prototype object */
{
  ...
  if (ecma_is_value_undefined (trap))
  {
    ecma_value_t result = call_set_prototype_of_internal_method (target_obj_p, proto);
    JERRY_BLOCK_TAIL_CALL_OPTIMIZATION ();
    return result;
  }
  ...
  /* 9. */
  ecma_value_t trap_result = call_call_internal_method (func_obj_p, handler, args, 2);
...
ecma_proxy_object_is_extensible (ecma_object_t *obj_p) /**< proxy object */
{
  ...
  if (ecma_is_value_undefined (trap))
  {
    ecma_value_t result = call_is_extensible_internal_method (target_obj_p);
    JERRY_BLOCK_TAIL_CALL_OPTIMIZATION ();
    return result;
  }
  ...
  /* 8. */
  ecma_value_t trap_result = call_call_internal_method (func_obj_p, handler, &target, 1);
  ...
  ecma_value_t target_result = call_is_extensible_internal_method (target_obj_p);
...
ecma_proxy_object_prevent_extensions (ecma_object_t *obj_p) /**< proxy object */
{
  ...
  {
    ecma_value_t target_is_ext = call_is_extensible_internal_method (target_obj_p);
                                    ...
                                    ecma_string_t *prop_name_p) /**< property name */
{
  ...
  if (ecma_is_value_undefined (trap))
  {
    ecma_property_descriptor_t result = call_get_own_property_internal_method (target_obj_p, prop_name_p);
    JERRY_BLOCK_TAIL_CALL_OPTIMIZATION ();
    return result;
  }
  ...
  /* 12. */
  ecma_property_descriptor_t target_prop_desc = call_get_own_property_internal_method (target_obj_p, prop_name_p);
                                       ...
                                       const ecma_property_descriptor_t *prop_desc_p) /**< property descriptor */
{
  ...
  if (ecma_is_value_undefined (trap))
  {
    ecma_value_t result = call_define_own_property_internal_method (target_obj_p, prop_name_p, prop_desc_p);
    JERRY_BLOCK_TAIL_CALL_OPTIMIZATION ();
    return result;
  }
  ...
  /* 10. */
  ecma_value_t trap_result = call_call_internal_method (func_obj_p, handler, args, 3);
                                ...
                                ecma_string_t *prop_name_p) /**< property name */
{
  ...
  if (ecma_is_value_undefined (trap))
  {
    ecma_value_t result = call_has_property_internal_method (target_obj_p, prop_name_p);
    JERRY_BLOCK_TAIL_CALL_OPTIMIZATION ();
    return result;
  }
  ...
  if (!boolean_trap_result && !(obj_p->u2.prototype_cp & JERRY_PROXY_SKIP_RESULT_VALIDATION))
  {
    ecma_property_descriptor_t prop_desc = call_get_own_property_internal_method (target_obj_p, prop_name_p);
                       ...
                       ecma_value_t receiver) /**< receiver to invoke getter function */
{
  ...
  if (ecma_is_value_undefined (trap))
  {
    ...
    ecma_value_t result = call_get_internal_method (target_obj_p, prop_name_p, receiver);
    JERRY_BLOCK_TAIL_CALL_OPTIMIZATION ();
    return result;
  }
  ...
  ecma_property_descriptor_t prop_desc =
    call_get_own_property_internal_method (ecma_get_object_from_value (proxy_obj_p->target), prop_name_p);
                       ...
                       bool is_strict) /**< indicate strict mode */
{
  ...
  if (ecma_is_value_undefined (trap))
  {
    ecma_value_t result = call_set_internal_method (target_obj_p, prop_name_p, value, receiver, is_strict);
    JERRY_BLOCK_TAIL_CALL_OPTIMIZATION ();
    return result;
  }
  ...
  /* 9. */
  ecma_value_t trap_result = call_call_internal_method (func_obj_p, handler, args, 4);
                                   ...
                                   bool is_strict) /**< delete in strict mode? */
{
  ...
  if (ecma_is_value_undefined (trap))
  {
    ecma_value_t result = call_delete_internal_method (target_obj_p, prop_name_p, is_strict);
    JERRY_BLOCK_TAIL_CALL_OPTIMIZATION ();
    return result;
  }
...
ecma_proxy_object_own_property_keys (ecma_object_t *obj_p, jerry_property_filter_t filter) /**< proxy object */
{
  ...
  if (ecma_is_value_undefined (trap))
  {
    ecma_collection_t *result = call_own_property_keys_internal_method (target_obj_p, JERRY_PROPERTY_FILTER_ALL);
    JERRY_BLOCK_TAIL_CALL_OPTIMIZATION ();
    return result;
  }
  ...
  /* 7. */
  ecma_value_t trap_result_array = call_call_internal_method (func_obj_p, handler, &target, 1);
  ...
  /* 11. */
  ecma_collection_t *target_keys = call_own_property_keys_internal_method (target_obj_p, JERRY_PROPERTY_FILTER_ALL);
                        ...
                        uint32_t argc) /**< number of arguments */
{
  ...
  {
    ecma_object_t *target_obj_p = ecma_get_object_from_value (target);
    ecma_value_t result = call_call_internal_method (target_obj_p, this_argument, args_p, argc);
    JERRY_BLOCK_TAIL_CALL_OPTIMIZATION ();
    return result;
  }
  ...
  ecma_object_t *func_obj_p = ecma_get_object_from_value (trap);
  /* 9. */
  ecma_value_t ret_value = call_call_internal_method (func_obj_p, handler, value_array, 3);
  ecma_deref_object (func_obj_p);
                             ...
                             uint32_t argc) /**< number of arguments */
{
  ...
  if (ecma_is_value_undefined (trap))
  {
    ...
    ecma_value_t result = call_construct_internal_method (target_obj_p, new_target_p, args_p, argc);
    JERRY_BLOCK_TAIL_CALL_OPTIMIZATION ();
    return result;
  }
  ...
  /* 9. */
  ecma_value_t new_obj = call_call_internal_method (func_obj_p, handler, function_call_args, 3);
