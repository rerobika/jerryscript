...
ecma_op_from_property_descriptor (const ecma_property_descriptor_t *src_prop_desc_p) /**< property descriptor */
{
  ...
  if (src_prop_desc_p->flags & (JERRY_PROP_IS_VALUE_DEFINED | JERRY_PROP_IS_WRITABLE_DEFINED))
  {
    ...
    completion =
      call_define_own_property_internal_method (obj_p, ecma_get_magic_string (LIT_MAGIC_STRING_VALUE), &prop_desc);
    ...
    completion =
      call_define_own_property_internal_method (obj_p, ecma_get_magic_string (LIT_MAGIC_STRING_WRITABLE), &prop_desc);
    JERRY_ASSERT (ecma_is_value_true (completion));
  }
  else
  {
...
#endif /* JERRY_ESNEXT */
    {
      ...
      completion =
        call_define_own_property_internal_method (obj_p, ecma_get_magic_string (LIT_MAGIC_STRING_GET), &prop_desc);
      JERRY_ASSERT (ecma_is_value_true (completion));

      /* b. */
      prop_desc.value = src_prop_desc_p->u.accessor.set;
      completion =
        call_define_own_property_internal_method (obj_p, ecma_get_magic_string (LIT_MAGIC_STRING_SET), &prop_desc);
      JERRY_ASSERT (ecma_is_value_true (completion));
    }
  }
  ...
  completion =
    call_define_own_property_internal_method (obj_p, ecma_get_magic_string (LIT_MAGIC_STRING_ENUMERABLE), &prop_desc);
  JERRY_ASSERT (ecma_is_value_true (completion));

  prop_desc.value = ecma_make_boolean_value (src_prop_desc_p->flags & JERRY_PROP_IS_CONFIGURABLE);

  completion =
    call_define_own_property_internal_method (obj_p, ecma_get_magic_string (LIT_MAGIC_STRING_CONFIGURABLE), &prop_desc);
  JERRY_ASSERT (ecma_is_value_true (completion));
...
/**
 * Function to create an object from a property reference
 *
 * @return constructed object
 */
ecma_object_t *
ecma_op_create_object_from_property_descriptor (
  const ecma_property_descriptor_t *prop_desc_p) /**< property reference */
{
  ecma_object_t *obj_p = ecma_op_create_object_object_noarg ();
  ...
  return obj_p;
} /* ecma_op_create_object_from_property_reference */
