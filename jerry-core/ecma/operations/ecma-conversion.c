...
ecma_op_from_property_descriptor (const ecma_property_descriptor_t *src_prop_desc_p) /**< property descriptor */
{
  ...
  {
    prop_desc.flags = (ECMA_PROP_IS_VALUE_DEFINED | ECMA_PROP_IS_WRITABLE_DEFINED | ECMA_PROP_IS_WRITABLE
                       | ECMA_PROP_IS_ENUMERABLE_DEFINED | ECMA_PROP_IS_ENUMERABLE | ECMA_PROP_IS_CONFIGURABLE_DEFINED
                                                                              ...
                                                                              *   unmodified otherwise */
{
  ...
  {
    uint32_t is_enumerable = (ecma_op_to_boolean (enumerable_prop_value) ? ECMA_PROP_IS_ENUMERABLE : ECMA_PROP_NO_OPTS);
  ...
  if (ecma_is_value_found (configurable_prop_value))
  {
    uint32_t is_configurable =
      (ecma_op_to_boolean (configurable_prop_value) ? ECMA_PROP_IS_CONFIGURABLE : ECMA_PROP_NO_OPTS);
  ...
  {
    uint32_t is_writable = (ecma_op_to_boolean (writable_prop_value) ? ECMA_PROP_IS_WRITABLE : ECMA_PROP_NO_OPTS);
