                           ...
                           ecma_value_t this_value) /**< this value */
{
  ...
  ecma_value_t result = call_call_internal_method (ecma_get_object_from_value (executor), this_value, argv, 2);
                                            ...
                                            const uint32_t args_count) /**< argument number */
{
  ...
  if (ecma_promise_remaining_inc_or_dec (executor_p->remaining_elements, false) == 0)
  {
    ...
    if (promise_type == ECMA_PROMISE_ANY_REJECT)
    {
      ...
      ret = call_call_internal_method (ecma_get_object_from_value (capability_p->reject),
    ...
    {
      ret = call_call_internal_method (ecma_get_object_from_value (capability_p->resolve),
                                       ECMA_VALUE_UNDEFINED,
                                       &executor_p->values,
                                       1);
    }
                             ...
                             ecma_value_t parent) /**< parent promise if available */
{
  ...
  {
    promise = call_construct_internal_method (constructor_obj_p, constructor_obj_p, &executor, 1);
  }
                                ...
                                bool is_resolve) /**< the operation is resolve */
{
  ...
  ecma_value_t call_ret =
    call_call_internal_method (ecma_get_object_from_value (func), ECMA_VALUE_UNDEFINED, &value, 1);
                                        ...
                                        ecma_value_t arg) /**< callback function argument */
{
  ...
  /* 4. */
  ecma_value_t result = call_call_internal_method (ecma_get_object_from_value (finally_func_obj->on_finally),
                                                   ECMA_VALUE_UNDEFINED,
                                                   NULL,
                                                   0);
                                  ...
                                  ecma_object_t *capability_obj_p) /**< capability */
{
  ...
  ecma_promise_capabality_t *capability_p = (ecma_promise_capabality_t *) capability_obj_p;
  ecma_value_t call_ret =
    call_call_internal_method (ecma_get_object_from_value (capability_p->reject), ECMA_VALUE_UNDEFINED, &reason, 1);
