                         ...
                         ecma_string_t *property_name_p) /**< property name */
{
  ...
  ecma_func_args_t func_args = ecma_op_make_call_args (getter_p, base_value, NULL, 0);
                                  ...
                                  bool is_throw) /**< flag that controls failure handling */
{
  ...
  ecma_func_args_t func_args = ecma_op_make_call_args (setter_p, receiver, &value, 1);
                ...
                uint32_t args_len) /**< Argument list length */
{
  ...
  ecma_func_args_t func_args = ecma_op_make_call_args (func_obj_p, this_arg, args_p, args_len);
  ecma_value_t call_result = ecma_op_function_call (&func_args);
