...
call_get_prototype_of_internal_method (ecma_object_t *obj_p) /**< object */
{
  return ECMA_OBJECT_INTERNAL_METHOD_TABLE (obj_p).get_prototype_of (obj_p);
} /* call_get_prototype_of_internal_method */
 ...
 */
extern inline ecma_value_t JERRY_ATTR_ALWAYS_INLINE
call_is_extensible_internal_method (ecma_object_t *obj_p) /**< object */
{
  return ECMA_OBJECT_INTERNAL_METHOD_TABLE (obj_p).is_extensible (obj_p);
} /* call_is_extensible_internal_method */
 ...
 */
extern inline ecma_value_t JERRY_ATTR_ALWAYS_INLINE
call_prevent_extensions_internal_method (ecma_object_t *obj_p) /**< object */
{
  return ECMA_OBJECT_INTERNAL_METHOD_TABLE (obj_p).prevent_extensions (obj_p);
} /* call_prevent_extensions_internal_method */
...
call_get_own_property_internal_method (ecma_object_t *obj_p, /**< the object */
                                       ecma_string_t *property_name_p) /**< property name */
{
  return ECMA_OBJECT_INTERNAL_METHOD_TABLE (obj_p).get_own_property (obj_p, property_name_p);
} /* call_get_own_property_internal_method */
 ...
 */
extern inline ecma_value_t JERRY_ATTR_ALWAYS_INLINE
call_has_property_internal_method (ecma_object_t *obj_p, /**< the object */
                                   ecma_string_t *property_name_p) /**< property name */
{
  return ECMA_OBJECT_INTERNAL_METHOD_TABLE (obj_p).has_property (obj_p, property_name_p);
} /* call_has_property_internal_method */
 ...
 */
extern inline ecma_value_t JERRY_ATTR_ALWAYS_INLINE
call_set_internal_method (ecma_object_t *obj_p, /**< the object */
                          ecma_string_t *property_name_p, /**< property name */
 ...
 */
extern inline ecma_value_t JERRY_ATTR_ALWAYS_INLINE
call_delete_internal_method (ecma_object_t *obj_p, /**< the object */
                             ecma_string_t *property_name_p, /**< property name */
...
call_own_property_keys_internal_method (ecma_object_t *obj_p, /**< object */
                                        jerry_property_filter_t filter) /**< name filters */
{
  return ECMA_OBJECT_INTERNAL_METHOD_TABLE (obj_p).own_property_keys (obj_p, filter);
} /* call_own_property_keys_internal_method */

/**
 * @return the result of the function call.
 */
extern inline ecma_value_t JERRY_ATTR_ALWAYS_INLINE
call_call_internal_method (ecma_object_t *obj_p, /**< function object */
...
} /* call_call_internal_method */

/**
 * @return the result of the function call.
 */
extern inline ecma_value_t JERRY_ATTR_ALWAYS_INLINE
call_validated_call_internal_method (ecma_value_t callee, /**< callee */
                                     ecma_value_t this_value, /**< 'this' argument's value */
                                     const ecma_value_t *arguments_list_p, /**< arguments list */
                                     uint32_t arguments_list_len) /**< length of arguments list */
{
  ...
  return call_call_internal_method (callee_p, this_value, arguments_list_p, arguments_list_len);
} /* call_validated_call_internal_method */

/**
 * @return the result of the function call.
 */
extern inline ecma_value_t JERRY_ATTR_ALWAYS_INLINE
call_construct_internal_method (ecma_object_t *obj_p, /**< function object */
                                ...
                                uint32_t arguments_list_len) /**< length of arguments list */
{
  ...
  return ECMA_OBJECT_INTERNAL_METHOD_TABLE (obj_p).construct (obj_p,
                                                              ...
                                                              arguments_list_p,
                                                              arguments_list_len);
} /* call_construct_internal_method */
...
call_list_lazy_property_keys_internal_method (ecma_object_t *obj_p, /**< a built-in object */
...
} /* call_list_lazy_property_keys_internal_method */
 ...
 */
extern inline void JERRY_ATTR_ALWAYS_INLINE
call_delete_builtin_property_internal_method (ecma_object_t *obj_p, /**< the object */
                                              ecma_string_t *property_name_p) /**< property name */
{
  ECMA_OBJECT_INTERNAL_METHOD_TABLE (obj_p).delete_builtin_property (obj_p, property_name_p);
} /* call_delete_builtin_property_internal_method */
                     ...
                     ecma_value_t receiver) /**< base value */
{
  ...
  {
    /* 2. */
    prop_desc = call_get_own_property_internal_method (obj_p, property_name_p);
  ...
  {
    return call_get_internal_method (obj_p, property_name_p, ecma_make_object_value (obj_p));
  }
                             ...
                             ecma_length_t index) /**< property index */
{
  ...
  if (JERRY_LIKELY (index <= ECMA_DIRECT_STRING_MAX_IMM))
  {
    return call_get_internal_method (object_p, ECMA_CREATE_DIRECT_UINT32_STRING (index), obj_value);
  }

  ecma_string_t *index_str_p = ecma_new_ecma_string_from_length (index);
  ecma_value_t ret_value = call_get_internal_method (object_p, index_str_p, obj_value);
  ecma_deref_ecma_string (index_str_p);
...
{
  return call_get_internal_method (object_p, ecma_get_magic_string (property_id), ecma_make_object_value (object_p));
                                 ...
                                 lit_magic_string_id_t property_id) /**< property symbol id */
{
  ...
  ecma_value_t ret_value = call_get_internal_method (object_p, symbol_p, ecma_make_object_value (object_p));
                    ...
                    ecma_string_t *prop_name_p) /** property name */
{
  ...
  ecma_value_t func = call_get_internal_method (obj_p, prop_name_p, obj_value);
                             ...
                             bool is_throw) /**< flag that controls failure handling */
{
  ...
  if (JERRY_LIKELY (index <= ECMA_DIRECT_STRING_MAX_IMM))
  {
    return call_set_internal_method (object_p, ECMA_CREATE_DIRECT_UINT32_STRING (index), value, obj_value, is_throw);
  }

  ecma_string_t *index_str_p = ecma_new_ecma_string_from_length (index);
  ecma_value_t ret_value = call_set_internal_method (object_p, index_str_p, value, obj_value, is_throw);
  ecma_deref_ecma_string (index_str_p);
                                ...
                                bool is_throw) /**< flag that controls failure handling */
{
  if (JERRY_LIKELY (index <= ECMA_DIRECT_STRING_MAX_IMM))
  {
    return call_delete_internal_method (obj_p, ECMA_CREATE_DIRECT_UINT32_STRING (index), is_throw);
  }

  ecma_string_t *index_str_p = ecma_new_ecma_string_from_length (index);
  ecma_value_t ret_value = call_delete_internal_method (obj_p, index_str_p, is_throw);
  ecma_deref_ecma_string (index_str_p);
                                ...
                                ecma_object_t *target_p) /**< target object */
{
  ...
  do
  {
    ecma_object_t *proto_p = call_get_prototype_of_internal_method (target_p);
                                              ...
                                              ecma_enumerable_property_names_options_t option) /**< listing option */
{
  ...
  ecma_collection_t *prop_names_p =
    call_own_property_keys_internal_method (obj_p, JERRY_PROPERTY_FILTER_EXCLUDE_SYMBOLS);
  ...
  for (uint32_t i = 0; i < prop_names_p->item_count; i++)
  {
    ...
    if (ecma_is_value_string (names_buffer_p[i]))
    {
      ...
      /* 4.a.i */
      ecma_property_descriptor_t prop_desc = call_get_own_property_internal_method (obj_p, key_p);
      ...
      if (is_enumerable)
      {
        ...
        {
          /* 4.a.ii.2.a */
          ecma_value_t value = call_get_internal_method (obj_p, key_p, ecma_make_object_value (obj_p));
...
ecma_op_object_enumerate (ecma_object_t *obj_p) /**< object */
{
  ...
  while (true)
  {
    ecma_collection_t *keys = call_own_property_keys_internal_method (obj_p, JERRY_PROPERTY_FILTER_EXCLUDE_SYMBOLS);
    ...
    for (uint32_t i = 0; i < keys->item_count; i++)
    {
      ...
      ecma_property_descriptor_t prop_desc = call_get_own_property_internal_method (obj_p, name_p);
                ...
                uint32_t args_len) /**< Argument list length */
{
  ...
  ecma_value_t func = call_get_internal_method (object_p, property_name_p, this_arg);
  ...
  /* 4. */
  ecma_value_t call_result = call_validated_call_internal_method (func, this_arg, args_p, args_len);
  ecma_free_value (func);
