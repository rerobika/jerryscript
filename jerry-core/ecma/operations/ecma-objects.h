...
ecma_object_t *call_get_prototype_of_internal_method (ecma_object_t *obj_p);
ecma_value_t call_set_prototype_of_internal_method (ecma_object_t *obj_p, ecma_value_t proto);
ecma_value_t call_is_extensible_internal_method (ecma_object_t *obj_p);
ecma_value_t call_prevent_extensions_internal_method (ecma_object_t *obj_p);
ecma_property_descriptor_t call_get_own_property_internal_method (ecma_object_t *obj_p, ecma_string_t *property_name_p);
ecma_value_t call_define_own_property_internal_method (ecma_object_t *obj_p,
                                                       ecma_string_t *property_name_p,
                                                       const ecma_property_descriptor_t *property_desc_p);
ecma_value_t call_has_property_internal_method (ecma_object_t *obj_p, ecma_string_t *property_name_p);
ecma_value_t call_get_internal_method (ecma_object_t *obj_p, ecma_string_t *property_name_p, ecma_value_t receiver);
ecma_value_t call_set_internal_method (ecma_object_t *obj_p,
                                       ecma_string_t *property_name_p,
                                       ecma_value_t value,
                                       ecma_value_t receiver,
                                       bool is_throw);
ecma_value_t call_delete_internal_method (ecma_object_t *obj_p, ecma_string_t *property_name_p, bool is_strict);
ecma_collection_t *call_own_property_keys_internal_method (ecma_object_t *obj_p, jerry_property_filter_t filter);

ecma_value_t call_call_internal_method (ecma_object_t *obj_p,
                                        ecma_value_t this_value,
                                        const ecma_value_t *arguments_list_p,
                                        uint32_t arguments_list_len);

ecma_value_t call_validated_call_internal_method (ecma_value_t callee,
                                                  ecma_value_t this_value,
                                                  const ecma_value_t *arguments_list_p,
                                                  uint32_t arguments_list_len);

ecma_value_t call_construct_internal_method (ecma_object_t *obj_p,
                                             ecma_object_t *new_target_p,
                                             const ecma_value_t *arguments_list_p,
                                             uint32_t arguments_list_len);

void call_list_lazy_property_keys_internal_method (ecma_object_t *obj_p,
                                                   ecma_collection_t *prop_names_p,
                                                   ecma_property_counter_t *prop_counter_p,
                                                   jerry_property_filter_t filter);

void call_delete_builtin_property_internal_method (ecma_object_t *obj_p, ecma_string_t *property_name_p);
