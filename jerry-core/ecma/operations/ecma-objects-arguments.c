...

{
  ...
  /* 11.a, 11.b */
  for (uint32_t index = 0; index < func_args_p->argc; index++)
  {
    ...
    prop_value_p->value = ecma_copy_value_if_not_object (func_args_p->argv[index]);
  ...
  prop_value_p->value = ecma_make_uint32_value (func_args_p->argc);
  ...
  if (!is_strict)
  {
    ...
    prop_value_p->value = ecma_make_object_value (func_args_p->func_obj_p);
  }
  else
  {
