                               ...
                               ecma_string_t *property_name_p) /**< property name */
{
  ...
  ecma_value_t ret_value = call_get_internal_method (obj_p, property_name_p, base_value);
                                ...
                                ecma_value_t value) /**< ECMA-value */
{
  ...
  while (true)
  {
    switch (ecma_get_lex_env_type (lex_env_p))
    {
      ...
      default:
      {
        ...
        ecma_value_t has_property = call_has_property_internal_method (binding_obj_p, name_p);
        ...
        if (ecma_is_value_true (has_property))
        {
          ecma_value_t completion =
            call_set_internal_method (binding_obj_p, name_p, value, ecma_make_object_value (binding_obj_p), is_strict);
  ...
  ecma_value_t completion =
    call_set_internal_method (lex_env_binding_obj, name_p, value, ecma_make_object_value (lex_env_binding_obj), false);
