                                ...
                                ecma_typedarray_setter_fn_t setter_cb) /**< setter callback function */
{
  ...
  if (func_object_p != NULL)
  {
    ...
    ecma_value_t cb_value = call_call_internal_method (func_object_p, this_val, call_args, 2);
...
/**
 * [[GetOwnProperty]] ecma typedarray object's operation
 *
 * See also:
...
/**
 * [[Get]] ecma typedarray object's operation
 *
 * See also:
...
/**
 * [[Set]] ecma typedarray object's operation
 *
 * See also:
...
} /* ecma_op_typedarray_list_lazy_property_keys */
                        ...
                        uint32_t arguments_list_len) /**< length of argument list */
{
  ecma_value_t ret_val =
    call_construct_internal_method (constructor_p, constructor_p, arguments_list_p, arguments_list_len);
