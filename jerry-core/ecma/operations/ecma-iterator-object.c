                      ...
                      ecma_value_t *next_method_p) /**< [out] next method */
{
  ...
  *next_method_p = ECMA_VALUE_UNDEFINED;
  ...
  /* 3. */
  ecma_value_t iterator = call_validated_call_internal_method (method, value, NULL, 0);
                       ...
                       ecma_value_t value) /**< the routines's value argument */
{
  ...
  if (has_value)
  {
    return call_call_internal_method (next_method_obj_p, iterator, &value, 1);
  }

  return call_call_internal_method (next_method_obj_p, iterator, NULL, 0);
                         ...
                         ecma_value_t value) /**< the routines's value argument */
{
  ...
  ecma_value_t result = call_validated_call_internal_method (func_return, iterator, &value, 1);
                        ...
                        ecma_value_t value) /**< the routines's value argument */
{
  ...
  ecma_value_t result = call_validated_call_internal_method (func_throw, iterator, &value, 1);
...
ecma_op_iterator_close (ecma_value_t iterator) /**< iterator value */
{
  ...
  ecma_value_t inner_result = call_call_internal_method (return_obj_p, iterator, NULL, 0);
