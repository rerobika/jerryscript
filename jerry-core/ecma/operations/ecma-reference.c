...
ecma_op_resolve_super_base (ecma_object_t *lex_env_p) /**< starting lexical environment */
{
  while (true)
  {
        ...
        && !ECMA_LEX_ENV_CLASS_IS_MODULE (lex_env_p))
    {
      ...
      ecma_object_t *proto_p = call_get_prototype_of_internal_method (home_p);
                            ...
                            ecma_string_t *prop_name_p) /**< property's name */
{
  ...
  if (ecma_is_value_object (unscopables))
  {
    ...
    ecma_value_t get_unscopables_value = call_get_internal_method (unscopables_obj_p, prop_name_p, unscopables);
      ...
      default:
      {
        ...
        if (lcache_lookup_allowed)
        {
          ...
          if (property_p != NULL)
          {
            ...
            return call_call_internal_method (getter_p, base_value, NULL, 0);
          }
#endif /* JERRY_LCACHE */
        }
