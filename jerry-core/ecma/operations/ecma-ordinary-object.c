                                                                                              ...
                                                                                              *   descriptor */
{
  ...
  ecma_property_descriptor_t current_prop = call_get_own_property_internal_method (object_p, property_name_p);
                                   ...
                                   ecma_string_t *property_name_p) /**< property name */
{
  ...
  {
    /* 2. */
    ecma_property_descriptor_t has_own = call_get_own_property_internal_method (object_p, property_name_p);
    ...
    {
      return call_has_property_internal_method (object_p, property_name_p);
    }
  }
                          ...
                          ecma_value_t receiver) /**< receiver */
{
  ...
  {
    /* 2. */
    prop_desc = call_get_own_property_internal_method (object_p, property_name_p);
    ...
    if (ECMA_OBJECT_GET_OWN_MAY_ABRUPT (object_p))
    {
      return call_get_internal_method (object_p, property_name_p, receiver);
    }
  }
...
ecma_ordinary_object_set_with_own_descriptor (ecma_string_t *property_name_p, /**< property name */
                                              ...
                                              ecma_value_t receiver, /**< receiver */
                                              ecma_property_descriptor_t *own_desc_p) /**<  */
{
  /* 3. */
  if (ecma_property_descriptor_is_data_descriptor (own_desc_p))
  {
    ...
    /* 3.c */
    ecma_property_descriptor_t exsisting_desc = call_get_own_property_internal_method (receiver_obj_p, property_name_p);
    ...
    if (ecma_property_descriptor_found (&exsisting_desc))
    {
      ...
      ecma_value_t define_value_result =
        call_define_own_property_internal_method (receiver_obj_p, property_name_p, &value_desc);
      ecma_free_property_descriptor (&exsisting_desc);
    ...
    /* 3.e.i */
    return call_define_own_property_internal_method (receiver_obj_p, property_name_p, &value_desc);
  }
  ...
  ecma_value_t setter_result = call_call_internal_method (setter_p, receiver, &value, 1);
...
{
  /* OrdinarySet 2. */
  ecma_property_descriptor_t own_desc = call_get_own_property_internal_method (object_p, property_name_p);
  ...
  while (!ecma_property_descriptor_found (&own_desc))
  {
    ...
    /* OrdinarySet 2. */
    own_desc = call_get_own_property_internal_method (obj_iter_p, property_name_p);
    JERRY_ASSERT (!ecma_property_descriptor_error (&own_desc));
  }
                             ...
                             bool is_throw) /**< flag that controls failure handling */
{
  ...
  {
    call_delete_builtin_property_internal_method (obj_p, property_name_p);
  }
                                        ...
                                        jerry_property_filter_t filter) /**< name filters */
{
  ...
  call_list_lazy_property_keys_internal_method (obj_p, prop_names_p, &prop_counter, filter);
 ...
 */
ecma_value_t
ecma_ordinary_object_call (ecma_object_t *obj_p, /**< built-in object */
 ...
 */
ecma_value_t
ecma_ordinary_object_construct (ecma_object_t *obj_p, /**< built-in object */
...
void
ecma_ordinary_object_list_lazy_property_keys (ecma_object_t *obj_p,
 ...
 */
void
ecma_ordinary_object_delete_builtin_property (ecma_object_t *obj_p, /**< the object */
                                              ecma_string_t *property_name_p) /**< property name */
{
  JERRY_UNUSED_2 (obj_p, property_name_p);
} /* ecma_ordinary_object_delete_builtin_property */
