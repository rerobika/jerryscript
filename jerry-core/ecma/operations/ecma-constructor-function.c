...
#if JERRY_ESNEXT
/**
 * [[Call]] internal method for class implicit constructor objects
 *
 * @return ecma value
                                     ...
                                     uint32_t arguments_list_len) /**< length of arguments list */
{
  ...
  ecma_value_t result =
    call_construct_internal_method (super_ctor_p, new_target_p, arguments_list_p, arguments_list_len);
