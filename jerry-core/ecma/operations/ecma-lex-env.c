                     ...
                     ecma_string_t *name_p) /**< argument N */
{
  ...
  switch (lex_env_type)
  {
    ...
    default:
    {
      ...
      return call_has_property_internal_method (binding_obj_p, name_p);
    }
  }
} /* ecma_op_has_binding */
                                ...
                                bool is_deletable) /**< argument D */
{
  ...
  else
  {
    ...
    ecma_value_t is_extensible = call_is_extensible_internal_method (binding_obj_p);
                        ...
                        ecma_string_t *name_p) /**< argument N */
{
  ...
  else
  {
    ...
    return call_delete_internal_method (binding_obj_p, name_p, false);
  }
