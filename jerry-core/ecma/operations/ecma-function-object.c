                               ...
                               ecma_value_t value) /**< argument 'V' */
{
  ...
  while (true)
  {
    ecma_object_t *current_proto_p = call_get_prototype_of_internal_method (v_obj_p);
...
{
  ecma_object_t *super_ctor_p = call_get_prototype_of_internal_method (func_obj_p);
 ...
 */
void
ecma_function_object_delete_built_in_property (ecma_object_t *object_p, /**< object */
                                               ecma_string_t *property_name_p) /**< property name */
{
  ecma_extended_object_t *ext_func_p = (ecma_extended_object_t *) object_p;
...
} /* ecma_function_object_delete_built_in_property */
