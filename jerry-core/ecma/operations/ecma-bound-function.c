 ...
 * @{
 *
 * \addtogroup ecmastringobject TODO related routines
 * @{
 */
  ...
  if (ecma_string_is_length (property_name_p))
  {
    ...
    if (ecma_object_get_class_name (target_func_p) == LIT_MAGIC_STRING_FUNCTION_UL)
    {
      ...
      ecma_value_t get_len_value =
        call_get_internal_method (target_func_p, property_name_p, ecma_make_object_value (target_func_p));
                          ...
                          uint32_t arguments_list_len) /**< length of arguments list */
{
  ...
  ecma_value_t ret_value = call_call_internal_method (target_obj_p,
                               ...
                               uint32_t arguments_list_len) /**< length of arguments list */
{
  ...
  ecma_value_t ret_value = call_construct_internal_method (target_obj_p,
                                                           new_target_p,
                                                           bound_arg_list_p->buffer_p + 1,
                                                           (uint32_t) (bound_arg_list_p->item_count - 1));
 ...
 */
void
ecma_bound_function_delete_built_in_property (ecma_object_t *object_p, /**< object */
                                              ecma_string_t *property_name_p) /**< property name */
{
...
} /* ecma_bound_function_delete_built_in_property */
