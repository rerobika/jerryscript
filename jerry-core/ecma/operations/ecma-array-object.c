                                      ...
                                      uint32_t length) /**< number of array elements */
{
  ...
  ecma_value_t *values_p =
    (ecma_value_t *) jmem_heap_alloc_block_null_on_error (aligned_length * sizeof (ecma_value_t));
                                   ...
                                   uint32_t new_length) /**< new length of the fast access mode array */
{
  ...
  else
  {
    ...
    ecma_value_t *new_values_p = (ecma_value_t *) jmem_heap_realloc_block (values_p,
                                 ...
                                 uint32_t flags) /**< configuration options */
{
  ...
  if (flags
      & (ECMA_PROP_IS_CONFIGURABLE | ECMA_PROP_IS_ENUMERABLE | ECMA_PROP_IS_GET_DEFINED | ECMA_PROP_IS_SET_DEFINED))
  {
  ...
  if ((flags & ECMA_PROP_IS_WRITABLE_DEFINED) && !(flags & ECMA_PROP_IS_WRITABLE))
  {
    if (ecma_op_array_is_fast_array (ext_object_p))
    {
      ecma_fast_array_convert_to_normal (object_p);
...
#define ECMA_FAST_ARRAY_DATA_PROP_FLAGS                                                            \
  (ECMA_PROP_IS_VALUE_DEFINED | ECMA_PROP_IS_ENUMERABLE_DEFINED | ECMA_PROP_IS_ENUMERABLE          \
   | ECMA_PROP_IS_CONFIGURABLE_DEFINED | ECMA_PROP_IS_CONFIGURABLE | ECMA_PROP_IS_WRITABLE_DEFINED \
