...
/**
 * [[GetOwnProperty]] ecma array object's operation
 *
 * See also:
...
} /* ecma_built_in_array_object_get_own_property */

/**
 * [[Get]] ecma array object's operation
 *
 * See also:
...

{
  ...
  if (JERRY_LIKELY (ecma_op_array_is_fast_array (ext_object_p)))
  {
    ...
    return call_get_internal_method (proto_p, property_name_p, receiver);
  }
...
/**
 * [[Set]] ecma array object's operation
 *
 * See also:
...
/**
 * [[Delete]] ecma array object's operation
 *
 * See also:
 *          ECMA-262 v12, ???
 *
...
void
ecma_array_object_list_lazy_property_keys (ecma_object_t *obj_p,
                              ...
                              ecma_length_t length) /**< length of the array */
{
  ...
  ecma_object_t *ctor_object_p = ecma_get_object_from_value (constructor);
  ecma_value_t ret_val = call_construct_internal_method (ctor_object_p, ctor_object_p, &len_val, 1);
...
ecma_array_object_to_string (ecma_value_t this_arg) /**< this argument */
{
  ...
  else
  {
    ...
    ret_value = call_call_internal_method (join_func_obj_p, this_arg, NULL, 0);
  }
