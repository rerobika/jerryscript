...
fail_put_lastindex:
  ...
  ret_value = call_set_internal_method (regexp_object_p,
                                        ecma_get_magic_string (LIT_MAGIC_STRING_LASTINDEX_UL),
                           ...
                           ecma_value_t string_arg) /**< string argument */
{
  ...
  ecma_value_t prev_last_index = call_get_internal_method (regexp_object_p, last_index_str_p, regexp_arg);
  ...
  if (prev_last_index != ecma_make_uint32_value (0))
  {
    const ecma_value_t status =
      call_set_internal_method (regexp_object_p, last_index_str_p, ecma_make_uint32_value (0), regexp_arg, true);
  ...
  /* 7. */
  ecma_value_t current_last_index = call_get_internal_method (regexp_object_p, last_index_str_p, regexp_arg);
  ...
  if (!same_value)
  {
    result = call_set_internal_method (regexp_object_p, last_index_str_p, prev_last_index, regexp_arg, true);
                          ...
                          ecma_value_t limit_arg) /**< limit value */
{
  ...
  ecma_value_t splitter = call_construct_internal_method (constructor_obj_p, constructor_obj_p, arguments, 2);
  ...
  while (current_index < string_length)
  {
    ...
    result = call_set_internal_method (splitter_obj_p, lastindex_str_p, index_value, splitter, true);
    ...
    /* 24.f.i. */
    result = call_get_internal_method (splitter_obj_p, lastindex_str_p, splitter);
                                 ...
                                 ecma_value_t replace_arg) /**< replace argument */
{
  ...
  if (JERRY_UNLIKELY ((ctx_p->flags & RE_FLAG_GLOBAL) == 0 && (re_ctx.flags & RE_FLAG_STICKY) != 0))
  {
    ...
    {
      result = call_set_internal_method ((ecma_object_t *) re_obj_p,
                                         ecma_get_magic_string (LIT_MAGIC_STRING_LASTINDEX_UL),
                                         ecma_make_uint32_value (0),
  ...
  while (true)
  {
    ...
    if (matched_p != NULL)
    {
      ...
      else
      {
        ...
        result =
          call_call_internal_method (function_p, ECMA_VALUE_UNDEFINED, arguments_p->buffer_p, arguments_p->item_count);
                            ...
                            ecma_value_t replace_arg) /**< replace string */
{
  ...
  if (replace_ctx.flags & RE_FLAG_GLOBAL)
  {
    ...
    result = call_set_internal_method (this_obj_p,
                                       ecma_get_magic_string (LIT_MAGIC_STRING_LASTINDEX_UL),
                                       ecma_make_uint32_value (0),
                                       this_arg,
                                       true);
  ...
  while (true)
  {
    ...
    if (ecma_op_is_callable (result))
    {
      ...
      result = call_call_internal_method (function_p, this_arg, arguments, 1);
       ...
       current_p++)
  {
    ...
    if (replace_ctx.replace_str_p == NULL)
    {
      ...
      result = call_call_internal_method (ecma_get_object_from_value (replace_arg),
                          ...
                          ecma_value_t string_arg) /**< source string */
{
  ...
  ecma_value_t set_status = call_set_internal_method (obj_p,
                                                      ecma_get_magic_string (LIT_MAGIC_STRING_LASTINDEX_UL),
                                                      ecma_make_uint32_value (0),
                                                      this_arg,
                                                      true);
  ...
  while (true)
  {
    ...
    if (is_match_empty)
    {
      ...
      last_index = ecma_make_length_value (index);
      ecma_value_t next_set_status = call_set_internal_method (obj_p,
                                                               ecma_get_magic_string (LIT_MAGIC_STRING_LASTINDEX_UL),
                                                               last_index,
                                                               this_arg,
                                                               true);
                     ...
                     ecma_string_t *str_p) /**< input string */
{
  ...
  if (ecma_op_is_callable (exec))
  {
    ...
    ecma_value_t result = call_call_internal_method (function_p, this_arg, arguments, 1);
