                                ...
                                jerry_external_handler_t handler_p) /**< function callback */
{
  ...
  jerry_value_t result_val = jerryx_handler_register (global_obj_val, name_p, handler_p);
 ...
 */
jerry_value_t
jerryx_handler_register (jerry_value_t object, /**< object to register property */
                         ...
                         jerry_external_handler_t handler_p) /**< function callback */
{
  ...
  jerry_value_t result_val = jerry_set_property (object, function_name_val, function_val);
